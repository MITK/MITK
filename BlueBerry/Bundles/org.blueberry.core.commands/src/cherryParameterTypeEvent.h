...
#ifndef CHERRYPARAMETERTYPEEVENT_H_
#define CHERRYPARAMETERTYPEEVENT_H_

#include "common/cherryAbstractHandleObjectEvent.h"
 ...
 */
class CHERRY_COMMANDS ParameterTypeEvent : public AbstractHandleObjectEvent {

public:

  cherryObjectMacro(ParameterTypeEvent)
...
#endif /* CHERRYPARAMETERTYPEEVENT_H_ */
