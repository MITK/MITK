...
#ifndef _CHERRY_JOBMANAGER_H
#define _CHERRY_JOBMANAGER_H

#include "cherryInternalJob.h"
#include "cherryJobQueue.h"
#include "cherryWorkerPool.h"
#include "cherryJobListeners.h"

#include "../cherryJob.h"
#include "../cherryIProgressMonitorWithBlocking.h"
 ...
 */
struct CHERRY_JOBS JobManager: public IJobManager
{
