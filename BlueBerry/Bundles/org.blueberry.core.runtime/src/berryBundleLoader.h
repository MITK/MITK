...
/**
 * Intentionally no org_blueberry_core_runtime_EXPORT macro. This class belongs into "internal" but
 * needs to stay here.
 */
class org_blueberry_core_runtime_EXPORT BundleLoader
{
...
private:
  ...
  struct BundleInfo {
    ...
    QHash<QString, Poco::Any*> m_ClassLoaderMap;
    SmartPointer<IBundleContext> m_Context;
  };

  typedef QHash<QString, BundleInfo> BundleMap;
...
public:
  ...
  template<class C>
  C* LoadClass(const QString& bundleName, const QString& className);
