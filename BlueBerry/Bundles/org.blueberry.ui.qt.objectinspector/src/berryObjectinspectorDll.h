...
#ifndef _BERRY_OBJECTINSPECTOR_EXPORT_DLL_H_
#define _BERRY_OBJECTINSPECTOR_EXPORT_DLL_H_
...
#if !defined(BERRY_OBJECTINSPECTOR_EXPORT)
  #define BERRY_OBJECTINSPECTOR_EXPORT
#endif

#endif /*_BERRY_OBJECTINSPECTOR_EXPORT_DLL_H_*/
