...
ActionContributionItem::ActionContributionItem(Action* action)
  : ContributionItem(action->GetId()), action(action)
{
}

bool ActionContributionItem::operator==(const Object* o) const
{
  if (const ActionContributionItem* aci = dynamic_cast<const ActionContributionItem*>(o))
  {
...
void ActionContributionItem::Fill(QStatusBar* parent)
{
...
QAction *ActionContributionItem::Fill(QMenu* parent, QAction* before)
{
  if (parent != 0)
  {
    if (before)
...
Action* ActionContributionItem::GetAction() const
{
  return action;
}
...
bool ActionContributionItem::IsEnabled() const
{
  return action != 0 && action->isEnabled();
}

bool ActionContributionItem::IsVisible() const
{
...
void ActionContributionItem::Update()
{
  Update(QString());
}

void ActionContributionItem::Update(const QString& propertyName)
{
//  if (widget != 0)
//  {
...
bool ActionContributionItem::IsEnabledAllowed() const
{
  if (this->GetParent() == 0)
  {
    return true;
...
//QString ActionContributionItem::ShortenText(const QString& textValue, QToolButton* item)
//{
//if (textValue == null) {
//  return null;
//}
...
//Listener ActionContributionItem::GetToolItemListener()
//{
...
//void ActionContributionItem::HandleWidgetDispose(Event e)
//{
...
//void ActionContributionItem::HandleWidgetSelection(Event e, bool selection)
//{
...
//bool ActionContributionItem::HasImages(Action* actionToCheck) const
//{
...
//bool ActionContributionItem::UpdateImages(bool forceImage)
//{
...
//void ActionContributionItem::DisposeOldImages()
//{
...
//Listener ActionContributionItem::getMenuCreatorListener() {
...
//void ActionContributionItem::HandleShowProxy(QMenu* proxy)
//{
...
//void ActionContributionItem::CopyMenu(QMenu* realMenu, QMenu* proxy) {
...
//void ActionContributionItem::HandleHideProxy(QMenu* proxy)
//{
