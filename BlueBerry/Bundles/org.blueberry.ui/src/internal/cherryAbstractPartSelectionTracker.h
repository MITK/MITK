...
#ifndef CHERRYABSTRACTPARTSELECTIONTRACKER_H_
#define CHERRYABSTRACTPARTSELECTIONTRACKER_H_
...
public:
  cherryObjectMacro(AbstractPartSelectionTracker);
...
#endif /* CHERRYABSTRACTPARTSELECTIONTRACKER_H_ */
