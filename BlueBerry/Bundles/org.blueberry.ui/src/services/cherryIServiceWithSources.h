...
#ifndef CHERRYISERVICEWITHSOURCES_H_
#define CHERRYISERVICEWITHSOURCES_H_

#include "cherryIDisposable.h"
 ...
 *
 */
struct CHERRY_UI IServiceWithSources : public IDisposable {

  cherryInterfaceMacro(IServiceWithSources, cherry)
...
#endif /* CHERRYISERVICEWITHSOURCES_H_ */
