...
MACRO(_MACRO_SETUP_PLUGIN_DEPENDENCIES _explicit_libs)
  ...
  WHILE(NOT "${_plugin_dependencies}" STREQUAL "${_plugin_old_dependencies}")
    ...
    FOREACH(_dep ${_plugin_dependencies})
      ...
      IF(NOT _plugin_src_dir) # maybe it is a CTK plugin dependency
        ...
        LIST(FIND CTK_PLUGIN_LIBRARIES ${_dep_target} dep_found)
        ...
        ELSE()
          ...
          IF(${_dep_target}_DEPENDENCIES)
            SET(_BUILD_${_dep} ON)
            GetMyTargetLibraries(_ctk_deps ${${_dep_target}_DEPENDENCIES})
  ...
  IF(NOT _dep_error)
    ...
    FOREACH(_dep ${_plugin_dependencies})
      ...
      ELSE()
        STRING(REPLACE . _ _dep_target ${_dep})
        IF(EXISTS "${${_dep_target}_SOURCE_DIR}/src")
          SET(_dep_src_dir "${${_dep_target}_SOURCE_DIR}/src")
        ELSE()
          SET(_dep_src_dir ${${_dep_target}_SOURCE_DIR})
        ENDIF()
      ENDIF()
