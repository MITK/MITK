...
#ifndef CHERRYCOMMANDMANAGER_H_
#define CHERRYCOMMANDMANAGER_H_

#include "common/cherryHandleObjectManager.h"
 ...
 * @since 3.1
 */
class CHERRY_COMMANDS CommandManager: public HandleObjectManager
{
...
public:
   ...
   * @since 3.2
   */
  static const std::string AUTOGENERATED_CATEGORY_ID; // = "org.opencherry.core.commands.categories.autogenerated";
