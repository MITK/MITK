...
#ifndef CHERRYIJOBCHANGELISTENER_H_
#define CHERRYIJOBCHANGELISTENER_H_

#include "cherryIJobChangeEvent.h"
...
struct CHERRY_JOBS IJobChangeListener: public Object
{

cherryInterfaceMacro(IJobChangeListener, cherry)

  struct CHERRY_JOBS Events
  {
...
CHERRY_DECLARE_OPERATORS_FOR_FLAGS(cherry::IJobChangeListener::Events::Types)

#endif /* CHERRYIJOBCHANGELISTENER_H_ */
