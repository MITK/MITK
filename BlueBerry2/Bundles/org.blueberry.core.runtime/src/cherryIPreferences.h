#ifndef CHERRYIPREFERENCES_H_
#define CHERRYIPREFERENCES_H_
...
namespace cherry 
{
   ...
   */
  struct CHERRY_RUNTIME IPreferences : virtual public Object
  {
    cherryInterfaceMacro(IPreferences, cherry)
