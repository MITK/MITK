...
#ifndef BERRYCOMMONRUNTIMEDLL_H_
#define BERRYCOMMONRUNTIMEDLL_H_
...
#if !defined(BERRY_COMMON_RUNTIME)
  #define BERRY_COMMON_RUNTIME
#endif

#endif /* BERRYCOMMONRUNTIMEDLL_H_ */
