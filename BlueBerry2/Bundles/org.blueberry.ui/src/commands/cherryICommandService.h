...
#ifndef CHERRYICOMMANDSERVICE_H_
#define CHERRYICOMMANDSERVICE_H_
 ...
 * @since 3.1
 */
struct CHERRY_UI ICommandService : public IDisposable {

  osgiInterfaceMacro(cherry::ICommandService)
...
#endif /* CHERRYICOMMANDSERVICE_H_ */
