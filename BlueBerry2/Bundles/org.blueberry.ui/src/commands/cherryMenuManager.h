...
#ifndef CHERRYMENUMANAGER_H_
#define CHERRYMENUMANAGER_H_

#include "cherryIMenuManager.h"
#include "cherryIMenuListener.h"
#include "cherryContributionManager.h"

#include "../guitk/cherryGuiTkIMenuListener.h"
 ...
 * </p>
 */
class CHERRY_UI MenuManager: public ContributionManager, public IMenuManager
{
