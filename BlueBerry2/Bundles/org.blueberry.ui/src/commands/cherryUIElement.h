...
#ifndef CHERRYUIELEMENT_H_
#define CHERRYUIELEMENT_H_
 ...
 * @since 3.3
 */
class CHERRY_UI UIElement : public Object {
...
OSGI_DECLARE_OPERATORS_FOR_FLAGS(cherry::UIElement::Styles)

#endif /* CHERRYUIELEMENT_H_ */
