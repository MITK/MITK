...
#include "cherryCommandPersistence.h"
...
#include "cherryParameterValueConverterProxy.h"
...
const int CommandPersistence::INDEX_COMMAND_DEFINITIONS = 1;
 const int CommandPersistence::INDEX_PARAMETER_TYPE_DEFINITIONS = 2;
  ...
  void CommandPersistence::ReadCommandsFromRegistry(
    ...
    LogWarnings(
        warningsToLog,
        "Warnings while parsing the commands from the 'org.opencherry.ui.commands' and 'org.opencherry.ui.actionDefinitions' extension points.");
  }
  ...
  void CommandPersistence::ReadParameterTypesFromRegistry(
    ...
    LogWarnings(
        warningsToLog,
        "Warnings while parsing the commandParameterTypes from the 'org.opencherry.ui.commands' extension point.");
