...
#ifndef CHERRYCOMMANDPERSISTENCE_H_
#define CHERRYCOMMANDPERSISTENCE_H_

#include "cherryRegistryPersistence.h"

#include <cherryParameter>
...
#endif /* CHERRYCOMMANDPERSISTENCE_H_ */
