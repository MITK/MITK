...
#ifndef CHERRYISTACKPRESENTATIONSITE_H_
#define CHERRYISTACKPRESENTATIONSITE_H_
...
struct CHERRY_UI IStackPresentationSite : public Object
{
  ...
  osgiInterfaceMacro(cherry::IStackPresentationSite);
...
#endif /* CHERRYISTACKPRESENTATIONSITE_H_ */
