...
#ifndef CHERRYBUNDLEHOST_H_
#define CHERRYBUNDLEHOST_H_

#include <osgi/framework/Bundle.h>
#include <osgi/framework/BundleActivator.h>
#include <openCherryAdapter/framework/cherryBundleData.h>
...
using namespace ::cherry::osgi::framework;
