...
#ifndef CHERRYFILTEREDSERVICELISTENER_H_
#define CHERRYFILTEREDSERVICELISTENER_H_
...
#include "../osgi.framework/cherryFilterImpl.h"
...
public:
  ...
  osgiObjectMacro(cherry::osgi::internal::FilteredServiceListener)
...
#endif /* CHERRYFILTEREDSERVICELISTENER_H_ */
