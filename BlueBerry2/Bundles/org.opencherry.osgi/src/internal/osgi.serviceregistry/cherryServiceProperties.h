...
#ifndef CHERRYSERVICEPROPERTIES_H_
#define CHERRYSERVICEPROPERTIES_H_
...
public:
  ...
  osgiObjectMacro(cherry::osgi::internal::ServiceProperties)
...
#endif /* CHERRYSERVICEPROPERTIES_H_ */
