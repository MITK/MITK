...
#ifndef CHERRYABSTRACTCONTRIBUTIONFACTORY_H_
#define CHERRYABSTRACTCONTRIBUTIONFACTORY_H_
 ...
 */
class CHERRY_UI AbstractContributionFactory: public Object
{
...
#endif /* CHERRYABSTRACTCONTRIBUTIONFACTORY_H_ */
