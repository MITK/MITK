...
#ifndef CHERRYICOMMANDIMAGESERVICE_H_
#define CHERRYICOMMANDIMAGESERVICE_H_
 ...
 * @since 3.4
 */
struct CHERRY_UI ICommandImageService : public IDisposable {

  osgiInterfaceMacro(cherry::ICommandImageService)
...
#endif /* CHERRYICOMMANDIMAGESERVICE_H_ */
