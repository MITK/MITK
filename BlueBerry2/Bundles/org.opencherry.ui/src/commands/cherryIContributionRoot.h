...
#ifndef CHERRYICONTRIBUTIONROOT_H_
#define CHERRYICONTRIBUTIONROOT_H_
 ...
 * @since 3.3
 */
struct CHERRY_UI IContributionRoot : public Object {

  osgiInterfaceMacro(cherry::IContributionRoot)
...
#endif /* CHERRYICONTRIBUTIONROOT_H_ */
