...
#ifndef CHERRYEVALUATIONAUTHORITY_H_
#define CHERRYEVALUATIONAUTHORITY_H_

#include "cherryExpressionAuthority.h"
#include "cherryEvaluationReference.h"
...
#endif /* CHERRYEVALUATIONAUTHORITY_H_ */
