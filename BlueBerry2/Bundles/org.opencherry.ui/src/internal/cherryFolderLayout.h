...
public:
    ...
    /* (non-Javadoc)
     * @see org.opencherry.ui.IPlaceholderFolderLayout#addPlaceholder(java.lang.String)
     */
    void AddPlaceholder(const std::string& viewId);

    /* (non-Javadoc)
     * @see org.opencherry.ui.IFolderLayout#addView(java.lang.String)
     */
    void AddView(const std::string& viewId);

    /* (non-Javadoc)
     * @see org.opencherry.ui.IPlaceholderFolderLayout#getProperty(java.lang.String)
     */
    std::string GetProperty(const std::string& id);

    /* (non-Javadoc)
     * @see org.opencherry.ui.IPlaceholderFolderLayout#setProperty(java.lang.String, java.lang.String)
     */
