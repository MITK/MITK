...
#ifndef CHERRYSTACKPRESENTATION_H_
#define CHERRYSTACKPRESENTATION_H_
 ...
 * @since 3.0
 */
class CHERRY_UI StackPresentation : public Object, public ISizeProvider {
...
#endif /* CHERRYSTACKPRESENTATION_H_ */
