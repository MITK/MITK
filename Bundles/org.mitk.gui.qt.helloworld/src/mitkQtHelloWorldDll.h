...
#ifndef MITKQTHELLOWORLDDLL_H_
#define MITKQTHELLOWORLDDLL_H_
...
//
  ...
  #if defined(org_mitk_gui_qt_helloworld_EXPORTS)
    #define MITK_QT_HELLOWORLD __declspec(dllexport)
  #else
    #define MITK_QT_HELLOWORLD __declspec(dllimport)  
  #endif
#endif

#if !defined(MITK_QT_HELLOWORLD)
  #define MITK_QT_HELLOWORLD
#endif

#endif /*MITKQTHELLOWORLDDLL_H_*/
