...
list(REMOVE_ITEM MITK_CONFIG_PLUGINS org.mitk.gui.qt.pythonenvironments)
...
if(DEFINED MITK_USE_pybind11 AND MITK_USE_pybind11)
    message(STATUS "MITK_USE_pybind11 is set to TRUE, remove it as we have selected a NoPython configuration")
    unset(MITK_USE_pybind11 CACHE)
endif()
