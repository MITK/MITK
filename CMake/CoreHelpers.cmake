...
IF(BUILD_TESTING)
  ...
  FOREACH( test ${MODULE_TESTS} )
    ...
    ADD_TEST(${TName} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}/${TESTDRIVER} ${TName})
  ENDFOREACH( test )
  ...
  FOREACH(image ${MODULE_TESTIMAGES} ${ADDITIONAL_TEST_IMAGES} )
    ...
    FOREACH( test ${MODULE_IMAGE_TESTS} )
      ...
      ADD_TEST(${TName}_${ImageName} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}/${TESTDRIVER} ${TName} ${IMAGE_FULL_PATH})
    ENDFOREACH( test )
