...
MACRO(CREATE_CORE_LIB)
  ...
  ADD_LIBRARY(${LIBNAME} ${CPP_FILES} ${H_FILES} ${CPP_FILES_MULTIPLEX} ${CORRESPONDING_H_FILES} ${CORRESPONDING_TXX_FILES} ${GLOBBED_TXX_FILES} ${GLOBBED_DOX_FILES} ${GLOBBED_UI_FILES} ${TOOL_CPPS})
