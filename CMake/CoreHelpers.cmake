...
MACRO(ORGANIZE_SOURCES)
  ...
  # All globbed txx-files can be found in the variable
  # ${GLOBBED_TXX_FILES}
...
MACRO(CREATE_CORE_LIB)
  ...
  ADD_LIBRARY(${LIBNAME} ${CPP_FILES} ${H_FILES} ${CPP_FILES_MULTIPLEX} ${CORRESPONDING_H_FILES} ${CORRESPONDING_TXX_FILES} ${GLOBBED_TXX_FILES})
...
MACRO(CREATE_QMITK)
  ...
  ADD_LIBRARY(Qmitk${LIBPOSTFIX} ${ARGV0} ${CPP_FILES} ${H_FILES} ${Q${KITNAME}_GENERATED_CPP} ${CORRESPONDING_H_FILES} ${CORRESPONDING_TXX_FILES} ${GLOBBED_TXX_FILES})
