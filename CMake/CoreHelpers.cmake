...
ENDIF(_MISSING_DEP)
  IF(NOT MODULE_IS_ENABLED)   
    # remove possibly existing config, to avoid strange error
    # this could maybe improved to create a "disabled" config
...
IF(BUILD_TESTING AND MODULE_IS_ENABLED)
  ...
  IF(DEFINED MODULE_TEST_MOC_H_FILES)
    QT4_WRAP_CPP(MODULE_TEST_GENERATED_MOC_CPP ${MODULE_TEST_MOC_H_FILES})
  ENDIF(DEFINED MODULE_TEST_MOC_H_FILES)
