...
MACRO(CREATE_CORE_LIB)
  ...
  # CPP_FILES_MULTIPLEX is generated by the MITK_MULTIPLEX_PICTYPE macro (see below)
  
  ORGANIZE_SOURCES(${CPP_FILES} ${H_FILES})
  
  ADD_LIBRARY(${LIBNAME} ${CPP_FILES} ${H_FILES} ${CPP_FILES_MULTIPLEX} ${CORRESPONDING_H_FILES} ${CORRESPONDING_TXX_FILES} ${GLOBBED_TXX_FILES} ${GLOBBED_DOX_FILES} ${GLOBBED_UI_FILES})
...
MACRO(CREATE_QMITK)
  ...
  ADD_LIBRARY(Qmitk${LIBPOSTFIX} ${ARGV0} ${CPP_FILES} ${H_FILES} ${Q${KITNAME}_GENERATED_CPP} ${CORRESPONDING_H_FILES} ${CORRESPONDING_TXX_FILES} ${GLOBBED_TXX_FILES} ${GLOBBED_DOX_FILES} ${GLOBBED_UI_FILES})
...
MACRO(MITK_MULTIPLEX_PICTYPE file)
  ...
  FOREACH(TYPE ${TYPES})
    ...
    SET(CPP_FILES_MULTIPLEX ${CPP_FILES_MULTIPLEX} ${CMAKE_CURRENT_BINARY_DIR}/${quoted_file})
  ENDFOREACH(TYPE)
