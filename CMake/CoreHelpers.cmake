...
MACRO(MITK_CREATE_MODULE MODULE_NAME_IN)
  MACRO_PARSE_ARGUMENTS(MODULE "INCLUDE_DIRS;INTERNAL_INCLUDE_DIRS;DEPENDS;DEPENDS_INTERNAL;PROVIDES;PACKAGE_DEPENDS;EXPORT_DEFINE;ADDITIONAL_LIBS;GENERATED_CPP" "QT_MODULE" ${ARGN})
  SET(MODULE_NAME ${MODULE_NAME_IN})
  IF(NOT MODULE_PROVIDES)
    SET(MODULE_PROVIDES ${MODULE_NAME})
  ENDIF(NOT MODULE_PROVIDES)
