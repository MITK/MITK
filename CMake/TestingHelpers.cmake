...
MACRO(MITK_CREATE_DEFAULT_TESTS)
  ...
  FOREACH( test ${${KITNAME}_TESTS} )
    ...
    ADD_TEST(${TName} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}/${KITNAME}TestDriver ${TName})
  ENDFOREACH( test )
  ...
  FOREACH(image ${${KITNAME}_TESTIMAGES} ${ADDITIONAL_TEST_IMAGES} )
    ...
    FOREACH( test ${${KITNAME}_IMAGE_TESTS} )
      ...
      ADD_TEST(${TName}_${ImageName} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}/${KITNAME}TestDriver ${TName} ${IMAGE_FULL_PATH})
    ENDFOREACH( test )
