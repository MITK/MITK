  ...
  if(NOT MODULE_IS_EXCLUDED)
    ...
    if(_MISSING_DEP)
      ...
      if(MODULE_IS_ENABLED)
        ...
        if(NOT MODULE_HEADERS_ONLY)
          ...
          if(RESOURCE_FILES)
            ...
            elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/Resources")
              ...
              message(SEND_ERROR "Resources specified but ${CMAKE_CURRENT_SOURCE_DIR}/resources directory not found.")
            endif()
        ...
        if(NOT MODULE_NO_DEFAULT_INCDLUE_DIRS)
          if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/include)
            target_include_directories(${MODULE_TARGET} PUBLIC include)
          else()
