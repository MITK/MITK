function(mitkFunctionOrganizeSources)
  ...
  # ${CORRESPONDING_TPP_FILES}
  # ${CORRESPONDING_UI_H_FILES}

  # Globbed can be found in the variables
  # ${GLOBBED_TPP_FILES} (CURRENTLY COMMENTED OUT)
  # ${GLOBBED_DOX_FILES}

  cmake_parse_arguments(_ORG "" "" "HEADER;SOURCE;TPP;DOC;META;UI;QRC" ${ARGN})
  ...
  if(_ORG_SOURCE)
    foreach(_file ${_ORG_SOURCE})
      string(REGEX REPLACE "(.*)\\.(tpp|cpp|c)$" "\\1.h" H_FILE ${_file})
  ...
  source_group("Template Files" FILES ${_ORG_TPP})
