...
function(mitk_use_modules)
  ...
  while(NOT "${depends}" STREQUAL "${depends_before}")
    ...
    foreach(dependency ${depends})
      ...
      if(MITK_USE_Qt4 AND ${dependency}_QT4_MODULES)
        list(APPEND package_depends Qt4)
      endif()
      if(MITK_USE_Qt5 AND ${dependency}_QT5_MODULES)
        list(APPEND package_depends ${${dependency}_QT5_MODULES})
      endif()
    endforeach()
