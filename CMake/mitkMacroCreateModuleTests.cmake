...
MACRO(MITK_CREATE_MODULE_TESTS)
  ...
  IF(BUILD_TESTING AND MODULE_IS_ENABLED)
    ...
    set_property(TARGET ${TESTDRIVER} PROPERTY LABELS MITK)
    ...
    FOREACH( test ${MODULE_TESTS} )
      ...
      set_property(TEST ${TName} PROPERTY LABELS MITK)
    ENDFOREACH( test )
    ...
    FOREACH(image ${MODULE_TESTIMAGES} ${ADDITIONAL_TEST_IMAGES} )
      ...
      set_property(TEST ${TName}_${ImageName} PROPERTY LABELS MITK)
      ENDFOREACH( test )
