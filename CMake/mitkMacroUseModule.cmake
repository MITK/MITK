macro(MITK_USE_MODULE)
  ...
  foreach(dependency ${DEPENDS} ${MODULE_DEPENDS_INTERNAL})
    ...
    if(${dependency}_IS_DEPRECATED AND NOT MODULE_IS_DEPRECATED)
      ...
      if(MODULE_FIRST_LEVEL_DEPENDS)
        list(FIND MODULE_FIRST_LEVEL_DEPENDS ${dependency} _index)
        if(_index GREATER -1)
