...
if(MITK_USE_Boost)
  ...
  if(NOT DEFINED BOOST_ROOT AND NOT MITK_USE_SYSTEM_Boost)
    ...
    if(MITK_USE_Boost_LIBRARIES)
      ...
      set(_boost_build_cmd ${CMAKE_CURRENT_BINARY_DIR}/${proj}-src/bjam --build-dir=${CMAKE_CURRENT_BINARY_DIR}/${proj}-build --prefix=${CMAKE_CURRENT_BINARY_DIR}/${proj}-install ${_boost_address_model} ${_boost_variant} ${_boost_libs} link=shared,static threading=multi runtime-link=shared -q install)
    else()
