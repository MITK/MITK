...
===================================================================*/
#ifndef __mitk2DTo3DImageFilter_h
#define __mitk2DTo3DImageFilter_h
...
namespace mitk
{
  ...
  class MITK_CORE_EXPORT 2DTo3DImageFilter : public ImageToImageFilter
  {
  public: 

    mitkClassMacro( 2DTo3DImageFilter , ImageToImageFilter );
    itkNewMacro( Self );
