...
namespace mitk
{
 ...
 //## @ingroup Adaptor
 template <typename ItkOutputImageType> extern void MITK_CORE_EXPORT CastToItkImage(mitk::Image * mitkImage, itk::SmartPointer<ItkOutputImageType>& itkOutputImage);
