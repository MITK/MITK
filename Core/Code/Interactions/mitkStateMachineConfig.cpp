...
#include "mitkStateMachineConfig.h"
...
namespace mitk
{
  vtkStandardNewMacro(StateMachineConfig);
}

mitk::StateMachineConfig::StateMachineConfig() :
    m_errors(false)
{
 ...
 **/
bool mitk::StateMachineConfig::LoadConfig(std::string fileName)
{
  if (fileName.empty())
    return false;
...
void mitk::StateMachineConfig::StartElement(const char* elementName, const char **atts)
{
...
void mitk::StateMachineConfig::EndElement(const char* elementName)
{
  std::string name(elementName);
...
std::string mitk::StateMachineConfig::ReadXMLStringAttribut(std::string name, const char** atts)
{
  if (atts)
  {
...
const mitk::PropertyList::Pointer mitk::StateMachineConfig::GetPropertyList()
{
  return m_PropertyList;
}

std::string mitk::StateMachineConfig::GetMappedEvent(InteractionEvent* interactionEvent)
{
...
bool mitk::StateMachineConfig::ReadXMLBooleanAttribut(std::string name, const char** atts)
{
