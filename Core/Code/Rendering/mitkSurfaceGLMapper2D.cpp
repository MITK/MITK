 ...
 // int timestep = this->GetTimestep();
  ...
  if(vtkpolydata!=NULL)
  {
    ...
    else
    {
      ...
      {
        AbstractTransformGeometry::ConstPointer surfaceAbstractGeometry = dynamic_cast<const AbstractTransformGeometry*>(input->GetTimeGeometry()->GetGeometryForTimeStep(0));
