                     ...
                     int outExt[6], int id)
{
  ...
  T active = (T)(self->GetActiveLabel());
  bool outlineAll = self->GetOutlineAll();
  T pix;
  ...
  for (outIdx2 = outMin2; outIdx2 <= outMax2; outIdx2++)
    ...
    for (outIdx1 = outMin1;
      ...
      for (outIdx0 = outMin0; outIdx0 <= outMax0; outIdx0++)
        {
        pix = *inPtr0;
        // Default output equal to input //backgnd
        *outPtr0 = backgnd;

        //if (pix != backgnd)
        if ( (outlineAll && (pix != backgnd)) || (!outlineAll && (pix == active)) )
          {
...
void vtkImageLabelOutline::PrintSelf(ostream& os, vtkIndent indent)
{
    ...
    os << indent << "Active Label: " << this->ActiveLabel << "\n";
