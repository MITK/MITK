...
int mitkImageAccessorTest(int argc, char* argv[])
{
   ...
   {
     mutexLockException = true;
   }

   MITK_TEST_CONDITION_REQUIRED( mutexLockException, "Testing a recursive mutex lock attempt, should end in an exception ..." );
