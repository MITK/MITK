...
int mitkImageCreatorTest(int /*argc*/, char* /*argv*/[])
{
    MITK_TEST_BEGIN("ToFImageWriter");

    //create some images with arbitrary parameters (corner cases)
    mitk::Image::Pointer image2Da = mitk::ImageCreator::CreateRandomImage<float>(120, 205);
    mitk::Image::Pointer image2Db = mitk::ImageCreator::CreateRandomImage<unsigned char>(1, 1, 0, 0);
    mitk::Image::Pointer image3Da = mitk::ImageCreator::CreateRandomImage<int>(512, 205, 1, 0);
    mitk::Image::Pointer image3Db = mitk::ImageCreator::CreateRandomImage<double>(512, 532, 112, 0);
    mitk::Image::Pointer image4Da = mitk::ImageCreator::CreateRandomImage<float>(120, 205, 78, 1);
    mitk::Image::Pointer image4Db = mitk::ImageCreator::CreateRandomImage<unsigned char>(550, 33, 78, 150);
