...
int mitkImageVtkMapper2DSwivelTest(int argc, char* argv[])
{
    ...
    //sets a swivel direction
    renderingHelper.SetSwivelDirection();
    ...
    {
        renderingHelper.SaveAsPNG("C:/home/src/MITK-Data/RenderingTestData/ReferenceScreenshots/pic3dSwivel640x480REF.png");
    }
