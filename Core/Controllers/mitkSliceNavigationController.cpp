...
/*!
  \todo implement it!
  */
void mitk::SliceNavigationController::SetGeometry3D(const mitk::Geometry3D &aGeometry3D)
{
}
...
/*!
  \todo implement it!
  */
void mitk::SliceNavigationController::SetPoint(const mitk::Point3D &point)
{
}
