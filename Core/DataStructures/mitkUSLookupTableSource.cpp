 ...
 *
 */
mitk::USLookupTableSource::OutputTypePointer mitk::USLookupTableSource::GetOutput()
{

    std::cout << "mitk:US:LookupTableSource::GetOutput() ... " << std::endl;
    ...
    std::cout << "mitk::USLookupTableSource::GetOutput() ... " << std::endl;
