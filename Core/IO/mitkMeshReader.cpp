...
void mitk::MeshReader::GenerateData()
{
    if ( m_FileName == "" )
    {
...
void mitk::MeshReader::GenerateOutputInformation()
{
}

int mitk::MeshReader::CanReadFile ( const char *name )
{
...
void mitk::MeshReader::ResizeOutputs( const unsigned int& num )
{
