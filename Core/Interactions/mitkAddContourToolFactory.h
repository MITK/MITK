...
=========================================================================*/
#ifndef __mitkAddContourToolFactory_h
#define __mitkAddContourToolFactory_h
...
/**
  ...
  $Author$
*/
class AddContourToolFactory : public itk::ObjectFactoryBase
{
  public:  
    /// ITK typedefs
    ...
    itkTypeMacro(AddContourToolFactory, itkObjectFactoryBase);

    /** Register one factory of this type  */
    static void RegisterOneFactory()
    {
      AddContourToolFactory::Pointer AddContourToolFactory = AddContourToolFactory::New();
      ObjectFactoryBase::RegisterFactory(AddContourToolFactory);
    }
  ...
  private:
    ...
    AddContourToolFactory(const Self&); //purposely not implemented
