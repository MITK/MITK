...
=========================================================================*/
#ifndef __mitkContourToolFactory_h
#define __mitkContourToolFactory_h
...
/**
  \brief Factory to create a mitk::ContourTool.
  ...
  $Author$
*/
class ContourToolFactory : public itk::ObjectFactoryBase
{
  public:  
    /// ITK typedefs
    typedef ContourToolFactory   Self;
    ...
    itkTypeMacro(ContourToolFactory, itkObjectFactoryBase);

    /** Register one factory of this type  */
    static void RegisterOneFactory()
    {
      ContourToolFactory::Pointer ContourToolFactory = ContourToolFactory::New();
      ObjectFactoryBase::RegisterFactory(ContourToolFactory);
    }
  ...
  private:
    ...
    ContourToolFactory(const Self&); //purposely not implemented
