...
=========================================================================*/
#ifndef __mitkEraseRegionToolFactory_h
#define __mitkEraseRegionToolFactory_h
...
/**
  \brief Factory to create a mitk::EraseRegionTool.
  ...
  $Author$
*/
class EraseRegionToolFactory : public itk::ObjectFactoryBase
{
  public:  
    /// ITK typedefs
    typedef EraseRegionToolFactory   Self;
    ...
    itkTypeMacro(EraseRegionToolFactory, itkObjectFactoryBase);

    /** Register one factory of this type  */
    static void RegisterOneFactory()
    {
      EraseRegionToolFactory::Pointer EraseRegionToolFactory = EraseRegionToolFactory::New();
      ObjectFactoryBase::RegisterFactory(EraseRegionToolFactory);
    }
    
  protected:

    EraseRegionToolFactory();
    ~EraseRegionToolFactory();

  private:

    EraseRegionToolFactory(const Self&); //purposely not implemented
