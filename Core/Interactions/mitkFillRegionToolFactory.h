...
=========================================================================*/
#ifndef __mitkFillRegionToolFactory_h
#define __mitkFillRegionToolFactory_h
...
/**
  \brief Factory to create a mitk::FillRegionTool.
  ...
  $Author$
*/
class FillRegionToolFactory : public itk::ObjectFactoryBase
{
  public:  
    /// ITK typedefs
    typedef FillRegionToolFactory   Self;
    ...
    itkTypeMacro(FillRegionToolFactory, itkObjectFactoryBase);

    /** Register one factory of this type  */
    static void RegisterOneFactory()
    {
      FillRegionToolFactory::Pointer FillRegionToolFactory = FillRegionToolFactory::New();
      ObjectFactoryBase::RegisterFactory(FillRegionToolFactory);
    }
    
  protected:

    FillRegionToolFactory();
    ~FillRegionToolFactory();

  private:

    FillRegionToolFactory(const Self&); //purposely not implemented
