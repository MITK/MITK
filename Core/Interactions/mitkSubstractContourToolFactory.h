...
=========================================================================*/
#ifndef __mitkSubstractContourToolFactory_h
#define __mitkSubstractContourToolFactory_h
...
/**
  \brief Factory to create a mitk::SubstractContourTool.
  ...
  $Author$
*/
class SubstractContourToolFactory : public itk::ObjectFactoryBase
{
  public:  
    /// ITK typedefs
    typedef SubstractContourToolFactory   Self;
    ...
    itkTypeMacro(SubstractContourToolFactory, itkObjectFactoryBase);

    /** Register one factory of this type  */
    static void RegisterOneFactory()
    {
      SubstractContourToolFactory::Pointer SubstractContourToolFactory = SubstractContourToolFactory::New();
      ObjectFactoryBase::RegisterFactory(SubstractContourToolFactory);
    }
    
  protected:

    SubstractContourToolFactory();
    ~SubstractContourToolFactory();

  private:

    SubstractContourToolFactory(const Self&); //purposely not implemented
