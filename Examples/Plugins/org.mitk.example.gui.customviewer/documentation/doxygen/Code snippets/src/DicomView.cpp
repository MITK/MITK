...
void DicomView::AddDataNodeFromDICOM(const QStringList& Properties)
{
  ...
  {        
      ...
      /*
      ctkServiceReference serviceReference = org_mitk_example_gui_customviewer_views_Activator::GetPluginContext()->getServiceReference<mitk::IDataStorageService>();
      mitk::IDataStorageService* storageService = org_mitk_example_gui_customviewer_views_Activator::GetPluginContext()->getService<mitk::IDataStorageService>(serviceReference);
