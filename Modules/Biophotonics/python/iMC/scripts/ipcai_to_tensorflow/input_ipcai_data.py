...
def read_data_sets(dir, fake_data=False):
    ...
    TRAIN_IMAGES = "ipcai_revision_colon_mean_scattering_train_all_virtual_camera.txt"
    TEST_IMAGES = "ipcai_revision_colon_mean_scattering_test_all_virtual_camera.txt"
