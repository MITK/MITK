...
mitk::SpectroCamController::SpectroCamController()
  :m_hDS(NULL),
   ...
   m_hView(NULL)
{
  SpectroCamRecorder::GetInstance().SetController(this);
}
...
{
  mitk::SpectroCamRecorder::GetInstance().DisplayCameraStream(image);
}

bool mitk::SpectroCamController::OpenCameraConnection()
    {
        //=====================OpenFactoryAndCamera=====================
            //Creat Factory and cam based on   //BOOL OpenFactoryAndCamera();        // Open factory and search for cameras. Open first camera
