...
var moduleNames = new Array("Diffusion Viewer",
                            "MITK Homepage");

// add the MITK-link to your module
var moduleLinks = new Array("mitk://mitk.perspectives/org.mitk.diffusionimagingapp.perspectives.diffusionimagingapp?dataset=/opt/dti-atlas/Fornix/rois_01.mitk",
                            "http://www.mitk.org");
...
var picFilenames = new Array("dti.jpg",
                             "dti.jpg");
...
var aniFilenames = new Array("dti_animated.gif",
                             "dti_animated.gif");
...
var moduleDescriptions = new Array("View and navigate through the datasets of the Springer DTI Atlas",
                                   "Download current Diffusion Application from mitk.org");
...
function showPopUpWindow(){
  ...
  container.id = "popup";
	...
	headline = document.createTextNode(moduleNames[modulePos] + " Module");
	...
	moduleLinkTxt = document.createTextNode("Click here to enter the " + moduleNames[modulePos].toLowerCase() + " mode");
