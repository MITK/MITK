...
#ifndef MITKQTCOMMONEXT_EXPORT_DLL_H_
#define MITKQTCOMMONEXT_EXPORT_DLL_H_
...
//
    ...
    #define MITK_QT_COMMON_EXT_EXPORT __declspec(dllexport)
  #else
    #define MITK_QT_COMMON_EXT_EXPORT __declspec(dllimport)
  #endif
#endif
...
#endif /*MITKQTCOMMONEXT_EXPORT_DLL_H_*/
