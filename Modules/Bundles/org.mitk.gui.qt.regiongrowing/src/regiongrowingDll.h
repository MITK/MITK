...
#ifndef _REGIONGROWING_DLL_H_
#define _REGIONGROWING_DLL_H_


//
// The following block is the standard way of creating macros which make exporting
// from a DLL simpler. All files within this DLL are compiled with the org_mitk_gui_qt_regiongrowing_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see
// org_mitk_gui_qt_regiongrowing_EXPORTS functions as being imported from a DLL, wheras this DLL sees symbols
