...
::GenerateData()
{
  ...
  PixelType distanceThreshold = 1;

  //Calculate the connected components
  typedef itk::ScalarConnectedComponentImageFilter <OutputImageType, LabelImageType, LabelImageType >
  ...
  typedef itk::LabelStatisticsImageFilter< FloatImageType, LabelImageType> LabelStatisticsImageFilterType;
...
*/
      run[0] = (labelStatisticsImageFilter->GetMinimum( labelValue ) + labelStatisticsImageFilter->GetMinimum( labelValue )) /2;
...
{
  MITK_WARN <<" -> Size zone old offset = " << offset;
  ...
  MITK_WARN << " -> size zone new  offset = " << offset;
