...
namespace itk
{
  ...
  LocalIntensityFilter< TInputImage >
    ::LocalIntensityFilter() :m_ThreadSum(1), m_SumOfSquares(1), m_Count(1), m_ThreadMin(1), m_ThreadMax(1)
  {
  ...
  template< typename TInputImage >
  typename LocalIntensityFilter< TInputImage >::PixelObjectType *
    LocalIntensityFilter< TInputImage >
    ::GetMinimumOutput()
  {
  ...
  template< typename TInputImage >
  const typename LocalIntensityFilter< TInputImage >::PixelObjectType *
    LocalIntensityFilter< TInputImage >
