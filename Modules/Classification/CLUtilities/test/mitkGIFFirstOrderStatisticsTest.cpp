...
public:
  ...
  void ImageDescription_PhantomTest()
  {
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL_MESSAGE("First Order::Standard Deviation with Large IBSI Phantom Image", 1.74513, results["First Order::Standard Deviation"], 0.01);
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL_MESSAGE("First Order::Excess Kurtosis with Large IBSI Phantom Image", 2.64538, results["First Order::Excess Kurtosis"], 0.01);
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL_MESSAGE("First Order::Sum of voxels with Large IBSI Phantom Image", 159, results["First Order::Sum of voxels"], 0.01);
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL_MESSAGE("First Order::Interquantile Range with Large IBSI Phantom Image", 3, results["First Order::Interquantile Range"], 0.01);
