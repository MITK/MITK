...
public:
  ...
  ImageStatisticsHolder(mitk::Image* image);
    ...
    //##Documentation
    //## \brief Get the minimum for scalar images. Recomputation performed only when neccessary.
    virtual ScalarType GetScalarValueMin(int t=0, unsigned int component=0);

    //##Documentation
    //## \brief Get the maximum for scalar images. Recomputation performed only when neccessary.
    virtual ScalarType GetScalarValueMax(int t=0, unsigned int component=0);

    //##Documentation
    //## \brief Get the second smallest value for scalar images. Recomputation performed only when neccessary.
