...
namespace
{
  ...
  void RegisterProperties()
  {
    ...
    service->RegisterProperty(mitk::AnnotationProperty::New());
    service->RegisterProperty(mitk::ClippingProperty::New());
    service->RegisterProperty(mitk::ColorProperty::New());
    service->RegisterProperty(mitk::BoolProperty::New());
    service->RegisterProperty(mitk::BoolLookupTableProperty::New());
    service->RegisterProperty(mitk::DoubleProperty::New());
    service->RegisterProperty(mitk::DoubleVectorProperty::New());
    service->RegisterProperty(mitk::FloatProperty::New());
    service->RegisterProperty(mitk::FloatLookupTableProperty::New());
    service->RegisterProperty(mitk::GroupTagProperty::New());
    service->RegisterProperty(mitk::IntProperty::New());
    service->RegisterProperty(mitk::IntLookupTableProperty::New());
    service->RegisterProperty(mitk::IntVectorProperty::New());
    service->RegisterProperty(mitk::LevelWindowProperty::New());
    service->RegisterProperty(mitk::LookupTableProperty::New());
    service->RegisterProperty(mitk::PlaneOrientationProperty::New());
    service->RegisterProperty(mitk::Point2dProperty::New());
    service->RegisterProperty(mitk::Point3dProperty::New());
    service->RegisterProperty(mitk::Point3iProperty::New());
    service->RegisterProperty(mitk::Point4dProperty::New());
    service->RegisterProperty(mitk::PointSetShapeProperty::New());
    service->RegisterProperty(mitk::ModalityProperty::New());
    service->RegisterProperty(mitk::RenderingModeProperty::New());
    service->RegisterProperty(mitk::StringProperty::New());
    service->RegisterProperty(mitk::StringLookupTableProperty::New());
    service->RegisterProperty(mitk::TemporoSpatialStringProperty::New());
    service->RegisterProperty(mitk::TransferFunctionProperty::New());
    service->RegisterProperty(mitk::UIntProperty::New());
    service->RegisterProperty(mitk::UShortProperty::New());
    service->RegisterProperty(mitk::Vector3DProperty::New());
    service->RegisterProperty(mitk::VtkInterpolationProperty::New());
    service->RegisterProperty(mitk::VtkRepresentationProperty::New());
    service->RegisterProperty(mitk::VtkResliceInterpolationProperty::New());
    service->RegisterProperty(mitk::VtkScalarModeProperty::New());
  }
}
