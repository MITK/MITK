...
public:
  ...
  {
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::ANY_MIMETYPE_NAME()", mitk::PropertyPersistenceInfo::ANY_MIMETYPE_NAME() == mitk::IOMimeTypes::DEFAULT_BASE_NAME() + ".any_type");
    ...
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::GetMimeTypeName()", info->GetMimeTypeName() == mitk::PropertyPersistenceInfo::ANY_MIMETYPE_NAME());
    ...
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::GetDeserializationFunction() producing a StringProperty", dynamic_cast<mitk::StringProperty*>(prop.GetPointer()));
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::GetDeserializationFunction() producing a StringProperty with correct value", prop->GetValueAsString() == refSerialization);
  ...
  void SetNameAndKey()
  {
    ...
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::SetNameAndKey() changed name", info->GetName() == "MyName");
  ...
  void UseRegEx()
  {
    ...
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::UseRegEx() changed name template", info->GetNameTemplate() == nameTemplate);
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::UseRegEx() changed key template", info->GetKeyTemplate() == nameTemplate);
  }
  ...
  void UseRegEx2()
  {
    ...
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::UseRegEx() changed name template", info->GetNameTemplate() == nameTemplate);
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::UseRegEx() changed key template", info->GetKeyTemplate() == keyTemplate);
  }
  ...
  void SetDeserializationFunction()
  {
    ...
    mitk::BaseProperty::Pointer prop = info->GetDeserializationFunction()(refSerialization);
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::SetDeserializationFunction() producing a StringProperty with correct value", prop->GetValueAsString() == refSerialization_testFunction);
  }
  ...
  void SetSerializationFunction()
  {
    ...
    std::string value = info->GetSerializationFunction()(refProp);
    CPPUNIT_ASSERT_MESSAGE("Testing PropertyPersistenceInfo::SetSerializationFunction()", value == refSerialization_testFunction);
  }
  ...
  void deserializeToStringProperty()
  {
    ...
    CPPUNIT_ASSERT_MESSAGE("Testing deserializeToStringProperty() producing a StringProperty", dynamic_cast<mitk::StringProperty*>(prop.GetPointer()));
    CPPUNIT_ASSERT_MESSAGE("Testing deserializeToStringProperty() producing a StringProperty with correct value", prop->GetValueAsString() == refSerialization);
  }
