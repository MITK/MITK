...
MITKCPPMICROSERVICES_EXPORT std::string any_value_to_string(const Any& any);

MITKCPPMICROSERVICES_EXPORT std::string any_value_to_json(const Any& val);
MITKCPPMICROSERVICES_EXPORT std::string any_value_to_json(const std::string& val);
MITKCPPMICROSERVICES_EXPORT std::string any_value_to_json(bool val);
