...
namespace mitk
{
  /**
   * @class RESTManagerQt
   * @brief this is a microservice for managing REST-requests, used for Qt applications.
   *
   * This class inherits from the RESTManager in the CppRestSdk Module, which is the equivalent service for
   * non-Qt applications.
   */
