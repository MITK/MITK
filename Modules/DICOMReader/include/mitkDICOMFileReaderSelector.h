...
/**
  ...
  This can especially lead to problem if these methods are used in the scope
  of anothers module's activator.
*/
class MITKDICOMREADER_EXPORT DICOMFileReaderSelector : public itk::LightObject
{
  public:
    ...
    /// is properly loaded. If the module is not available these method will do nothing.
    /// This can especially lead to problem if these methods are used in the scope
    /// of anothers module's activator.
