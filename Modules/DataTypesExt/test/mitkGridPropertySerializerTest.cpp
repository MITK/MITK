...
class mitkGridPropertySerializerTestSuite : public mitk::TestFixture
{
  CPPUNIT_TEST_SUITE(mitkGridPropertySerializerTestSuite);
  MITK_TEST(RoundTripGridRepresentation);
  MITK_TEST(RoundTripGridVolumeMapper);
...
public:
  void RoundTripGridRepresentation()
  {
    RoundTrip<mitk::GridRepresentationProperty>(mitk::GridRepresentationProperty::WIREFRAME);
  }

  void RoundTripGridVolumeMapper()
  {
    RoundTrip<mitk::GridVolumeMapperProperty>(mitk::GridVolumeMapperProperty::PT);
  }
};

MITK_TEST_SUITE_REGISTRATION(mitkGridPropertySerializer)
