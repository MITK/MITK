...
{
  InternalVectorType::const_iterator pos = std::find_if(this->m_IsoLevels.begin(), this->m_IsoLevels.end(), rt::EqualDoseFunctor(value));
...
void mitk::IsoDoseLevelSet::SetIsoDoseLevel(const IsoDoseLevel* level)
{
  ...
  std::sort(this->m_IsoLevels.begin(), this->m_IsoLevels.end(),rt::lesserIsoDoseLevel);
};
...
{
  InternalVectorType::iterator pos = std::find_if(this->m_IsoLevels.begin(), this->m_IsoLevels.end(), rt::EqualDoseFunctor(value));
