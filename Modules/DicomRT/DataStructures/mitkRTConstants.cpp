...
const std::string mitk::rt::Constants::DOSE_SHOW_ISOLINES_PROPERTY_NAME = "dose.showIsoLines";
const std::string mitk::rt::Constants::DOSE_SHOW_COLORWASH_PROPERTY_NAME = "dose.showColorWash";
const std::string mitk::rt::Constants::DOSE_ISO_LEVELS_PROPERTY_NAME = "dose.isoLevels";
const std::string mitk::rt::Constants::DOSE_FREE_ISO_VALUES_PROPERTY_NAME = "dose.freeIsoValues";
