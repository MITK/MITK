...
int main(int argc, char* argv[])
{
  ...
  parser.addArgument("", "i", mitkCommandLineParser::File, "Input network", "input connectomics network (.cnf)", us::Any(), false, false, false, mitkCommandLineParser::Input);
  parser.addArgument("", "o", mitkCommandLineParser::File, "Output file", "name of output file", us::Any(), false, false, false, mitkCommandLineParser::Output);
