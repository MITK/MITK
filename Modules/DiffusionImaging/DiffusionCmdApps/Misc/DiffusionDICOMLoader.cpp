...
int main(int argc, char* argv[])
{
  ...
  parser.addArgument("", "i", mitkCommandLineParser::Directory, "Input Directory" ,"input directory containing dicom files", us::Any(), false, false, false, mitkCommandLineParser::Input);
  parser.addArgument("", "o", mitkCommandLineParser::File, "Output File Name", "output file", us::Any(), false, false, false, mitkCommandLineParser::Output);
