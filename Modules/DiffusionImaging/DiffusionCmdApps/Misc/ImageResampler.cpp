...
int main( int argc, char* argv[] )
{
  ...
  parser.addArgument("", "i", mitkCommandLineParser::Image, "Input:", "Input file",us::Any(),false, false, false, mitkCommandLineParser::Input);
  ...
  parser.addArgument("reference", "r", mitkCommandLineParser::Image, "Reference:", "Resample using supplied reference image. Also cuts image to same dimensions",us::Any(), true, false, false, mitkCommandLineParser::Input);
