...
int StartPeakExtraction(int argc, char* argv[])
{
  ...
  parser.addArgument("", "i", mitkCommandLineParser::File, "Input image", "sh coefficient image", us::Any(), false, false, false, mitkCommandLineParser::Input);
  parser.addArgument("", "o", mitkCommandLineParser::Directory, "Output directory", "output root", us::Any(), false, false, false, mitkCommandLineParser::Output);
  parser.addArgument("mask", "", mitkCommandLineParser::File, "Mask", "mask image", us::Any(), true, false, false, mitkCommandLineParser::Input);
...
int main(int argc, char* argv[])
{
  ...
  parser.addArgument("mask", "m", mitkCommandLineParser::File, "Mask", "mask image", us::Any(), true, false, false, mitkCommandLineParser::Input);
