...
int main( int argc, char* argv[] )
{
  ...
  parser.addArgument("", "i", mitkCommandLineParser::Directory, "Input:", "Input folder",us::Any(),false, false, false, mitkCommandLineParser::Input);
  parser.addArgument("", "o", mitkCommandLineParser::Directory, "Output:", "Output folder (ending with /)",us::Any(),false, false, false, mitkCommandLineParser::Output);
