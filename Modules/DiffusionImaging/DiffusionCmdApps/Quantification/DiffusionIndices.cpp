...
int main(int argc, char* argv[])
{
  ...
  parser.addArgument("", "i", mitkCommandLineParser::String, "Input:", "input image (tensor, ODF or FSL/MRTrix SH-coefficient image)", us::Any(), false, false, false, mitkCommandLineParser::Input);
