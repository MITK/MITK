...
int main( int argc, char* argv[] )
{
  ...
  // mandatory arguments
  parser.addArgument("", "i", mitkCommandLineParser::File, "Input: ", "input image (DWI)", us::Any(), false, false, false, mitkCommandLineParser::Input);
  ...
  // optional arguments
  parser.addArgument("mask", "m", mitkCommandLineParser::File, "Masking Image: ", "ROI (segmentation)", us::Any(), true, false, false, mitkCommandLineParser::Input);
