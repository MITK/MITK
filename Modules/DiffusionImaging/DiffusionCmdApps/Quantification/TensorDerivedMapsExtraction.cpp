...
int main(int argc, char* argv[])
{
  ...
  parser.addArgument("", "i", mitkCommandLineParser::String, "Input file", "input dwi file", us::Any(),false, false, false, mitkCommandLineParser::Input);
  parser.addArgument("", "o", mitkCommandLineParser::String, "Output folder", "output folder and base name, e.g. /tmp/outPatient1 ", us::Any(),false, false, false, mitkCommandLineParser::Output);
