...
int main(int argc, char* argv[])
{
  ...
  parser.addArgument("", "a", mitkCommandLineParser::File, "Anchor tractogram:", "anchor tracts in one tractogram file", us::Any(), true, false, false, mitkCommandLineParser::Input);
  ...
  parser.addArgument("mask", "", mitkCommandLineParser::File, "Mask image:", "scoring is only performed inside the mask image", us::Any(), true, false, false, mitkCommandLineParser::Input);
