...
{                                                                                                   \
  ...
  _accessTwoImagesByItkForEach(itkImageTypeFunction, ((short, dimension))((unsigned short, dimension))((float, dimension)), ((short, dimension))((unsigned short, dimension))((float, dimension)) ) \
  {                                                                                                 \
