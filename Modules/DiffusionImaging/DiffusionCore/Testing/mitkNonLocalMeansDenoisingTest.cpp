...
*/
  void setUp() override
  {
    ...
    m_Image =  dynamic_cast<mitk::Image*>(mitk::IOUtil::Load(imagePath)[0].GetPointer());
  ...
  void Denoise_NLMg_shouldReturnTrue()
  {
    ...
    m_ReferenceImage =  dynamic_cast<mitk::Image*>(mitk::IOUtil::Load(referenceImagePath)[0].GetPointer());
