  ...
  */
  ...
  public:
    ...
    void Load(us::ModuleContext* context) override
    {
      ...
      mitk::CoreServices::GetPropertyDescriptions()->AddDescription(mitk::DiffusionPropertyHelper::GRADIENTCONTAINERPROPERTYNAME, "This gradients used during acquisition.");
