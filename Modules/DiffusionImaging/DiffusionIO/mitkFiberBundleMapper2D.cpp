...
void mitk::FiberBundleMapper2D::Update(mitk::BaseRenderer * renderer)
{
  ...
  node->SetFloatProperty("shader.mitkShaderFiberClipping.fiberSliceThickness",thickness);
...
void mitk::FiberBundleMapper2D::UpdateShaderParameter(mitk::BaseRenderer * renderer)
{
  ...
  node->SetFloatProperty("shader.mitkShaderFiberClipping.slicingPlane.w",distance,renderer);
