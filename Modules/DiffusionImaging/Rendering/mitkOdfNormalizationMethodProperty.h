...
class MitkDiffusionImaging_EXPORT OdfNormalizationMethodPropertySerializer : public BasePropertySerializer
{
  public:

    mitkClassMacro( OdfNormalizationMethodPropertySerializer, BasePropertySerializer );
    itkNewMacro(Self);
