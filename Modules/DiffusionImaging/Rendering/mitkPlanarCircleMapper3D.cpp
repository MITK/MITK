...
void mitk::PlanarCircleMapper3D::GenerateData()
{
 ...
 /* get my circle */
  mitk::PlanarCircle::Pointer PFCircle = dynamic_cast< mitk::PlanarCircle* > (this->GetData());
  ...
  mitk::Geometry2D::ConstPointer pfgeometry = PFCircle->GetGeometry2D();
  mitk::PlaneGeometry::ConstPointer planeGeo = dynamic_cast<const mitk::PlaneGeometry*> (pfgeometry.GetPointer());
...
void mitk::PlanarCircleMapper3D::SetDefaultProperties(mitk::DataNode* node, mitk::BaseRenderer* renderer, bool overwrite)
{
 ...
 // node->AddProperty( "enableIn3D", mitk::BoolProperty::New( true ), renderer, overwrite  );
