...
/*
 * This is the module activator for the IO aspects of the "perfusion" module.
 */
class PerfusionModelsActivator : public us::ModuleActivator
{
public:
...
US_EXPORT_MODULE_ACTIVATOR(mitk::PerfusionModelsActivator)
