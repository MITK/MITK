...
namespace mitk
{
  ...
  namespace modelFit
  {
     ...
     */
    class MITKFITMIDATA_EXPORT ModelFitInfo : public itk::LightObject
    {
    public:
     ...
     */
    MITKFITMIDATA_EXPORT const std::string GetMandatoryProperty(const mitk::DataNode* node,
    ...
    *	@throw ModelFitException	If the property doesn't exist or returns an empty string.
    */
    MITKFITMIDATA_EXPORT const std::string GetMandatoryProperty(const mitk::BaseData* data,
      const std::string& prop);
     ...
     */
    MITKFITMIDATA_EXPORT ModelFitInfo::Pointer CreateFitInfoFromNode(const ModelFitInfo::UIDType& uid,
    ...
    *	@return			The newly created modelfit on success or NULL otherwise.*/
    MITKFITMIDATA_EXPORT ModelFitInfo::Pointer CreateFitInfoFromModelParameterizer(
     ...
     */
    MITKFITMIDATA_EXPORT DataStorage::SetOfObjects::ConstPointer GetNodesOfFit(
     ...
     */
    MITKFITMIDATA_EXPORT NodeUIDSetType GetFitUIDsOfNode(const mitk::DataNode* node,
        const mitk::DataStorage* storage);
