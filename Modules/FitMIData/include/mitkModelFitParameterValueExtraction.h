...
namespace mitk
{
  ...
  MITKFITMIDATA_EXPORT ModelTraitsInterface::ParameterValueType ReadVoxel(const mitk::Image* image,
  ...
  MITKFITMIDATA_EXPORT ModelTraitsInterface::ParameterValueType ReadVoxel(const mitk::Image* image,
    ...
    */
    MITKFITMIDATA_EXPORT ParameterValueMapType ExtractParameterValueMapFromModelFit(const mitk::modelFit::ModelFitInfo* fitInfo,
    ...
    MITKFITMIDATA_EXPORT ModelTraitsInterface::ParametersType
