...
namespace mitk
{
  ...
  DataNode::Pointer MITKFITMIDATA_EXPORT GetNodeByModelFitUID(const mitk::DataStorage* storage, const NodeUIDType& uid);
  ...
  NodeUIDType MITKFITMIDATA_EXPORT EnsureModelFitUID(mitk::BaseData* data);
  ...
  NodeUIDType MITKFITMIDATA_EXPORT EnsureModelFitUID(mitk::DataNode* node);
  ...
  bool MITKFITMIDATA_EXPORT CheckModelFitUID(const mitk::BaseData* data, const NodeUIDType& uid);
  /** Convinience helper function that calls the overloaded CheckModelFitUID() with the data of the passed node.*/
  bool MITKFITMIDATA_EXPORT CheckModelFitUID(const mitk::DataNode* node, const NodeUIDType& uid);
