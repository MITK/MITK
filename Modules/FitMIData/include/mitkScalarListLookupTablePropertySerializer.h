...
namespace mitk
{
  ...
  namespace PropertyPersistenceSerialization
  {
    ...
    MITKFITMIDATA_EXPORT ::std::string serializeScalarListLookupTablePropertyToXML(const mitk::BaseProperty *prop);
  }

  namespace PropertyPersistenceDeserialization
  {
    /**Deserialize a passed XML string into a ScalarListLookupTableProperty.*/
    MITKFITMIDATA_EXPORT mitk::BaseProperty::Pointer deserializeXMLToScalarListLookupTableProperty(const std::string &value);
  }
}
