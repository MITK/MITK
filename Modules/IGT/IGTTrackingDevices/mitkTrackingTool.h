...
namespace mitk
{
  ...
  */
  ...
  public:
    ...
    virtual void SetToolTip(mitk::Point3D toolTipPosition, mitk::Quaternion orientation, ScalarType eps=0.0) = 0; ///< defines a tool tip for this tool in tool coordinates. GetPosition() and GetOrientation() return the data of the tool tip if it is defined. By default no tooltip is defined.
