...
/** @brief Defines a tool tip for this tool in tool coordinates.
*         GetPosition() and GetOrientation() return the data of
*         the tool tip if it is defined. By default no tooltip is defined.
*   @param toolTipPosition The position of the tooltip in tool coordinates.
*   @param orientation The orientation of the tooltip in tool coordinates. The orientation is set to identity by default.
*/
virtual void SetToolTip(mitk::Point3D toolTipPosition, mitk::Quaternion orientation = mitk::Quaternion(0,0,0,1));
