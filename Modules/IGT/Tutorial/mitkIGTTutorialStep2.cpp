...
int main(int argc, char* argv[])
{
  ...
  mitk::TimeSlicedGeometry::Pointer timeSlicedGeometry = dataStorage->ComputeBoundingGeometry3D(dataStorage->GetAll());
  timeSlicedGeometry->SetBounds(bounds);
  mitk::RenderingManager::GetInstance()->InitializeViews( timeSlicedGeometry );
