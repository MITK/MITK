...
{
  /**
   * \brief ITK object factory for creating PointSetReader instances.
   *
   * Registers mitk::PointSetReader with the ITK object factory mechanism,
   * enabling automatic creation of readers for MITK point set XML files.
   *
   * \ingroup MitkLegacyIOModule
   * \sa mitk::PointSetReader
   */
  class MITKLEGACYIO_EXPORT PointSetIOFactory : public itk::ObjectFactoryBase
  {
  public:
     ...
     * \return A raw pointer to a new PointSetIOFactory instance.
     */
