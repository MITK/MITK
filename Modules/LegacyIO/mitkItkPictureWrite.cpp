...
#define InstantiateAccessFunction__mitkItkPictureWrite(pixelType, dim) \
  template LegacyIO_EXPORT void _mitkItkPictureWrite(itk::Image<pixelType,dim>*, const std::string&);

#define InstantiateAccessFunction__mitkItkPictureWriteComposite(pixelType, dim) \
  template LegacyIO_EXPORT void _mitkItkPictureWriteComposite(itk::Image<pixelType,dim>*, const std::string&);
