...
void mitk::OverwriteDirectedPlaneImageFilter::ItkImageProcessing( itk::Image<TPixel1,VImageDimension1>* inputImage, itk::Image<TPixel2,VImageDimension2>* outputImage )
{
  ...
  int debugCounter( 0 );
  std::fstream overriderFile("C:/Users/fetzer/Desktop/SurfaceInterpolation/overridePoints.txt");
...
//*/
	...
	//{
		//overriderFile<<"[ "<<outputIndex[0]<<", "<<outputIndex[1]<<", "<<outputIndex[2]<<" ]"<<std::endl;
	//}
