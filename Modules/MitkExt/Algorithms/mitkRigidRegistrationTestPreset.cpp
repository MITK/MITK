...
namespace mitk {
  ...
  RigidRegistrationTestPreset::RigidRegistrationTestPreset()
  {
    m_Name = "";
    m_XmlFileName = "mitkRigidRegistrationTestPresets.xml";
  }
  ...
  bool RigidRegistrationTestPreset::LoadPreset()
  {
    ...
    std::string xmlFileName = mitk::StandardFileLocations::GetInstance()->FindFile("mitkRigidRegistrationTestPresets.xml", "Config");
  ...
  bool RigidRegistrationTestPreset::LoadPreset(std::string fileName)
  {
    if ( fileName.empty() )
      return false;
    ...
    {
  #ifdef INTERDEBUG
      MITK_INFO<<"RigidRegistrationTestPreset::LoadPreset xml file cannot parse!"<<std::endl;
  #endif
    }
  ...
  void  RigidRegistrationTestPreset::StartElement (const char *elementName, const char **atts)
  {
  ...
  std::string RigidRegistrationTestPreset::ReadXMLStringAttribut( std::string name, const char** atts )
  {
    if(atts)
    {
  ...
  itk::Array<double> RigidRegistrationTestPreset::getTransformValues(std::string name)
  {
    return m_TransformValues[name];
  }

  itk::Array<double> RigidRegistrationTestPreset::getMetricValues(std::string name)
  {
    return m_MetricValues[name];
  }

  itk::Array<double> RigidRegistrationTestPreset::getOptimizerValues(std::string name)
  {
    return m_OptimizerValues[name];
  }

  itk::Array<double> RigidRegistrationTestPreset::getInterpolatorValues(std::string name)
  {
    return m_InterpolatorValues[name];
  }

  std::map<std::string, itk::Array<double> >& RigidRegistrationTestPreset::getTransformValuesPresets()
  {
    return m_TransformValues;
  }

  std::map<std::string, itk::Array<double> >& RigidRegistrationTestPreset::getMetricValuesPresets()
  {
    return m_MetricValues;
  }

  std::map<std::string, itk::Array<double> >& RigidRegistrationTestPreset::getOptimizerValuesPresets()
  {
    return m_OptimizerValues;
  }

  std::map<std::string, itk::Array<double> >& RigidRegistrationTestPreset::getInterpolatorValuesPresets()
  {
    return m_InterpolatorValues;
  }

  bool RigidRegistrationTestPreset::save()
  {
  ...
  //bool RigidRegistrationTestPreset::saveXML(mitk::XMLWriter& xmlWriter)
  //{
  ...
  bool RigidRegistrationTestPreset::newPresets(std::map<std::string, itk::Array<double> > newTransformValues, std::map<std::string, itk::Array<double> > newMetricValues,
  ...
  //void RigidRegistrationTestPreset::saveTransformValues(mitk::XMLWriter& xmlWriter, std::string item)
  //{
  ...
  //void RigidRegistrationTestPreset::saveMetricValues(mitk::XMLWriter& xmlWriter, std::string item)
  //{
  ...
  //void RigidRegistrationTestPreset::saveOptimizerValues(mitk::XMLWriter& xmlWriter, std::string item)
  //{
  ...
  //void RigidRegistrationTestPreset::saveInterpolatorValues(mitk::XMLWriter& xmlWriter, std::string item)
  //{
  //  itk::Array<double> interpolatorValues = m_InterpolatorValues[item];
  //  xmlWriter.WriteProperty("INTERPOLATOR", interpolatorValues[0]);
  //}

  itk::Array<double> RigidRegistrationTestPreset::loadTransformValues(itk::Array<double> transformValues, double transform, const char **atts)
  {
    if (transform == mitk::TransformParameters::TRANSLATIONTRANSFORM || transform == mitk::TransformParameters::SCALETRANSFORM || 
          transform == mitk::TransformParameters::SCALELOGARITHMICTRANSFORM || transform == mitk::TransformParameters::VERSORTRANSFORM ||
          transform == mitk::TransformParameters::RIGID2DTRANSFORM || transform == mitk::TransformParameters::EULER2DTRANSFORM)
  ...
  itk::Array<double> RigidRegistrationTestPreset::loadMetricValues(itk::Array<double> metricValues, double metric, const char **atts)
  {
  ...
  itk::Array<double> RigidRegistrationTestPreset::loadOptimizerValues(itk::Array<double> optimizerValues, double optimizer, const char **atts)
  {
  ...
  itk::Array<double> RigidRegistrationTestPreset::loadInterpolatorValues(itk::Array<double> interpolatorValues/*, double interpolator, const char **atts*/)
  {
