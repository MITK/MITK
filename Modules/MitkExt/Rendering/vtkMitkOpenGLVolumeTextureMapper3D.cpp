...
void vtkMitkOpenGLVolumeTextureMapper3D::RenderOneIndependentNoShadeFP(
  ...
  vtkVolume *vol )
{
  //GPU_INFO << "RenderOneIndependentNoShadeFP";
...
void vtkMitkOpenGLVolumeTextureMapper3D::RenderTwoDependentNoShadeFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  //GPU_INFO << "RenderTwoDependentNoShadeFP";
...
void vtkMitkOpenGLVolumeTextureMapper3D::RenderFourDependentNoShadeFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  //GPU_INFO << "RenderFourDependentNoShadeFP";
