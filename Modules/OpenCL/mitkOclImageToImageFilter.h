...
/** @class OclImageToImageFilter
  * @brief The OclImageToImageFilter is the base class for all OpenCL image filter
  */
...
public:
  ...
  /*!
    * \brief Returns an pointer to the graphics memory.
    *
    * Use this method when executing two and more filters on the GPU,
    * this method does not copy the data to RAM, returns only a pointer.
    */
