...
private:
  ...
  const std::string TYPE_TRANSFORM = "TRANSFORM";
  const std::string TYPE_POSITION = "POSITION";
  const std::string TYPE_STATUS = "STATUS";
  const std::string TYPE_CAPABILITY = "CAPABILITY";
  const std::string TYPE_TEST = "TEST";
