...
void createTextOverlayWithLayouter(mitk::OverlayManager::Pointer OverlayManager, std::string layouter, mitk::BaseRenderer* renderer,
...
int mitkTextOverlay2DLayouterRenderingTest(int argc, char* argv[])
{
  ...
  {
    renderingHelper.SaveReferenceScreenShot("/home/christoph/Pictures/RenderingTestData/mitkTextOverlay2DLayouterRenderingTest_rgbImage.png");
  }
