...
class mitkColorBarOverlayTestSuite : public mitk::TestFixture
{
  CPPUNIT_TEST_SUITE(mitkColorBarOverlayTestSuite);
  MITK_TEST(RenderColorBarOverlay);
...
public:
   ...
   * resolution.
   */
  mitkColorBarOverlayTestSuite() : m_RenderingTestHelper(300, 300) {}
  /**
  ...
  void RenderColorBarOverlay()
  {
    ...
    std::string refImagePath = GetTestDataFilePath(m_ReferenceImagePath + "mitkColorBarOverlay.png");
    ...
    mitk::ColorBarOverlay::Pointer colorbar = mitk::ColorBarOverlay::New();
...
MITK_TEST_SUITE_REGISTRATION(mitkColorBarOverlay)
