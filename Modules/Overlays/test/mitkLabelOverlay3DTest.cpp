...
class mitkLabelOverlay3DTestSuite : public mitk::TestFixture
{
  CPPUNIT_TEST_SUITE(mitkLabelOverlay3DTestSuite);
...
public:
   ...
   * resolution.
   */
  mitkLabelOverlay3DTestSuite() : m_RenderingTestHelper(300, 300) {}
  /**
  ...
  {
    std::string refImagePath = GetTestDataFilePath(m_ReferenceImagePath + "mitkLabelOverlay3D.png");
    ...
    mitk::AnnotationPlacer::AddOverlay(label3d.GetPointer(), renderer);
...
MITK_TEST_SUITE_REGISTRATION(mitkLabelOverlay3D)
