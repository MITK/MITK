...
class mitkLogoOverlayTestSuite : public mitk::TestFixture
{
  CPPUNIT_TEST_SUITE(mitkLogoOverlayTestSuite);
...
public:
   ...
   * resolution.
   */
  mitkLogoOverlayTestSuite() : m_RenderingTestHelper(300, 300) {}
  /**
  ...
  void RenderMbiLogo()
  {
    ...
    std::string refImagePath = GetTestDataFilePath(m_ReferenceImagePath + "LogoOverlay_mbiLogo.png");
    ...
    mitk::LogoOverlay::Pointer logoOverlay = mitk::LogoOverlay::New();

    logoOverlay->SetLogoImagePath("mbilogo");

    mitk::BaseRenderer *renderer = mitk::BaseRenderer::GetInstance(m_RenderingTestHelper.GetVtkRenderWindow());
    mitk::AnnotationPlacer::AddOverlay(logoOverlay.GetPointer(), renderer);
  ...
  void RenderLogo()
  {
    ...
    std::string refImagePath = GetTestDataFilePath(m_ReferenceImagePath + "LogoOverlay.png");
    ...
    logoOverlay->SetLogoImagePath(m_PathToLogo);
...
MITK_TEST_SUITE_REGISTRATION(mitkLogoOverlay)
