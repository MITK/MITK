...
class mitkScaleLegendOverlayTestSuite : public mitk::TestFixture
{
  CPPUNIT_TEST_SUITE(mitkScaleLegendOverlayTestSuite);
  MITK_TEST(RenderScaleLegendOverlay);
...
public:
   ...
   * resolution.
   */
  mitkScaleLegendOverlayTestSuite() : m_RenderingTestHelper(300, 300) {}
  /**
  ...
  void RenderScaleLegendOverlay()
  {
    ...
    std::string refImagePath = GetTestDataFilePath(m_ReferenceImagePath + "mitkScaleLegendOverlay.png");
    ...
    mitk::ScaleLegendOverlay::Pointer colorbar = mitk::ScaleLegendOverlay::New();

    mitk::BaseRenderer *renderer = mitk::BaseRenderer::GetInstance(m_RenderingTestHelper.GetVtkRenderWindow());
    mitk::AnnotationPlacer::AddOverlay(colorbar.GetPointer(), renderer);
...
MITK_TEST_SUITE_REGISTRATION(mitkScaleLegendOverlay)
