...
const double mitk::HALFLIFECONSTANTS::VALUE_18F = 6586.26;
const double mitk::HALFLIFECONSTANTS::VALUE_68Ga = 4057.74;
const double mitk::HALFLIFECONSTANTS::VALUE_11C = 1223.4;
const double mitk::HALFLIFECONSTANTS::VALUE_15O = 122.24;
