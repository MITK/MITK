...
namespace mitk
{
   ...
   * \brief Implementation of the Extended Tofts pharmacokinetic model using an Arterial Input Function.
   *
   * Calculates the concentration-time curve as a convolution of the plasma curve Cp (the AIF)
   * and an exponential residue function R(t) = ktrans * exp(-ktrans/ve * t), plus a
   * vascular plasma contribution:
   * \code
   ...
   *
   * \sa StandardToftsModel, AIFBasedModelBase
   */
