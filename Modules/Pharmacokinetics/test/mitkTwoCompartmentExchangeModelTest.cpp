...
public:
  void setUp() override
  {
    ...
    m_testparameters[mitk::TwoCompartmentExchangeModel::POSITION_PARAMETER_F] = 37.70;
    m_testparameters(mitk::TwoCompartmentExchangeModel::POSITION_PARAMETER_PS) = 4.84;
    m_testparameters(mitk::TwoCompartmentExchangeModel::POSITION_PARAMETER_ve) = 32.68;
    m_testparameters(mitk::TwoCompartmentExchangeModel::POSITION_PARAMETER_vp) = 0.41;
  ...
  void ComputeModelfunctionTest()
  {
    ...
    CPPUNIT_ASSERT_MESSAGE("Checking signal at time frame 10.", mitk::Equal(0.596441, m_output[10], 1e-6, true) == true);
    CPPUNIT_ASSERT_MESSAGE("Checking signal at time frame 20.", mitk::Equal(1.267918, m_output[20], 1e-6, true) == true);
    CPPUNIT_ASSERT_MESSAGE("Checking signal at time frame 30.", mitk::Equal(1.494677, m_output[30], 1e-6, true) == true);
    CPPUNIT_ASSERT_MESSAGE("Checking signal at time frame 40.", mitk::Equal(1.599685, m_output[40], 1e-6, true) == true);
    CPPUNIT_ASSERT_MESSAGE("Checking signal at time frame 50.", mitk::Equal(1.640139, m_output[50], 1e-6, true) == true);
  }
