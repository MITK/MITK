...
*/
class MITKPHOTOACOUSTICSALGORITHMS_EXPORT PhotoacousticMotionCorrectionFilter
...
protected:
   ...
   */
  void InsertMatrixAsSlice(cv::Mat mat, mitk::Image::Pointer output,
                             unsigned int i);
...
*/
  unsigned int
      m_Levels; /*!< See @c levels in @c cv::calcOpticalFlowFarneback */
  unsigned int
      m_WinSize; /*!< See @c winsize in @c cv::calcOpticalFlowFarneback */
  unsigned int
      m_Iterations; /*!< See @c iterations in @c cv::calcOpticalFlowFarneback */
  ...
  unsigned int
      m_BatchSize; /*!< Determines how many slices belong together and will be
  ...
  cv::Mat
      m_Flow; /*!< Contains the optical flow between @c m_UsRef and @c m_UsMat*/
