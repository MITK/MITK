...
void mitk::PhotoacousticBeamformingUtils::DASQuadraticLine(float* input, float* output, float inputDim[2], float outputDim[2], const short& line, float* apodisation, const short& apodArraySize)
{
...
void mitk::PhotoacousticBeamformingUtils::DASSphericalLine(float* input, float* output, float inputDim[2], float outputDim[2], const short& line, float* apodisation, const short& apodArraySize)
{
  float& inputS = inputDim[1];
  float& inputL = inputDim[0];
...
void mitk::PhotoacousticBeamformingUtils::DMASQuadraticLine(float* input, float* output, float inputDim[2], float outputDim[2], const short& line, float* apodisation, const short& apodArraySize)
{
  float& inputS = inputDim[1];
  float& inputL = inputDim[0];
...
void mitk::PhotoacousticBeamformingUtils::DMASSphericalLine(float* input, float* output, float inputDim[2], float outputDim[2], const short& line, float* apodisation, const short& apodArraySize)
{
  float& inputS = inputDim[1];
  float& inputL = inputDim[0];
...
void mitk::PhotoacousticBeamformingUtils::sDMASQuadraticLine(float* input, float* output, float inputDim[2], float outputDim[2], const short& line, float* apodisation, const short& apodArraySize)
{
  float& inputS = inputDim[1];
  float& inputL = inputDim[0];
...
void mitk::PhotoacousticBeamformingUtils::sDMASSphericalLine(float* input, float* output, float inputDim[2], float outputDim[2], const short& line, float* apodisation, const short& apodArraySize)
{
  float& inputS = inputDim[1];
  float& inputL = inputDim[0];
