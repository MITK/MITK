  ...
  case AcCHECKEQUALS1:
    {
      ...
      unsigned int numberOfControlPoints, minimumNumberOfControlPoints;

      numberOfControlPoints = planarFigure->GetNumberOfControlPoints();
      minimumNumberOfControlPoints = planarFigure->GetMinimumNumberOfControlPoints();
