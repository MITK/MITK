...
public:
  ...
  void testSimpleITKMedianFilterSnippet()
  {
    ...
    sitk::Image sitkImage = medianFilter.Execute(mitk::SimpleItkImageImport::MitkToSimpleItkImage(m_Image));
    mitk::Image::Pointer mitkImage = mitk::SimpleItkImageImport::SimpleItkToMitkImage(sitkImage);
