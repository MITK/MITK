...
/**
  ...
  \param name Qt name
*/
QmitkDataTreeComboBox::QmitkDataTreeComboBox(QWidget* parent)
: QComboBox(parent),
...
/**
  ...
  \param name Qt name
*/
QmitkDataTreeComboBox::QmitkDataTreeComboBox(mitk::DataTreeFilter* filter,QWidget* parent)
: QComboBox(parent),
...
/**
  ...
  \param name Qt name
*/
QmitkDataTreeComboBox::QmitkDataTreeComboBox(mitk::DataTreeBase* tree,QWidget* parent)
: QComboBox(parent),
  m_DataTreeFilter(NULL),
  m_CurrentNode(NULL)
{
...
/**
  ...
  \param name Qt name
*/
QmitkDataTreeComboBox::QmitkDataTreeComboBox(mitk::DataTreeIteratorBase* iterator,QWidget* parent)
: QComboBox(parent),
  m_DataTreeFilter(NULL),
  m_CurrentNode(NULL)
{
                                           ...
                                           int level)
{
  ...
  while ( itemiter != itemiterend ) // for all items
  {
    ...
    QComboBox::insertItem(m_Items.size(), displayedText);

    if (itemiter->GetNode() == m_CurrentNode)
    {
      QComboBox::setCurrentIndex( QComboBox::count()-1 ); // select the recently added item
    }
...
void QmitkDataTreeComboBox::generateItems()
{
  ...
  try
  {
    if ( (QComboBox::currentIndex() < 0) || (m_Items.size() == 0) )
    {
    ...
    mitk::DataTreeFilter::Item* currentItem = const_cast<mitk::DataTreeFilter::Item*>(m_Items.at( QComboBox::currentIndex() ));
