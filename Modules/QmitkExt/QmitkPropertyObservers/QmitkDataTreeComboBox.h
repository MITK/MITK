...
class QMITKEXT_EXPORT QmitkDataTreeComboBox : public QComboBox
{
  ...
  public:
    ...
    QmitkDataTreeComboBox(QWidget* parent = 0);
    QmitkDataTreeComboBox(mitk::DataTreeFilter* filter,QWidget* parent = 0);
    QmitkDataTreeComboBox(mitk::DataTreeBase* filter,QWidget* parent = 0);
    QmitkDataTreeComboBox(mitk::DataTreeIteratorBase* filter,QWidget* parent = 0);
