...
void QmlMitkStdMultiItem::init()
{
    ...
    m_mouseMode->AddRenderer(m_viewerAxial->GetRenderer());
    m_mouseMode->AddRenderer(m_viewerFrontal->GetRenderer());
    m_mouseMode->AddRenderer(m_viewerSagittal->GetRenderer());
    m_mouseMode->AddRenderer(m_viewerOriginal->GetRenderer());
