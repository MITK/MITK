 ...
 : QWidget(parent, f)
{
  ...
  m_LevelInput->setToolTip("Edit this to change the center of the levelwindow");
  ...
  m_WindowInput->setToolTip("Edit this to change the span of the levelwindow. This number describes the whole span around the center.");
