...
void QmitkStdMultiWidget::AddDisplayPlaneSubTree()
{
  ...
  m_PlaneNode1 = renderer1->GetCurrentWorldGeometry2DNode();
  ...
  m_PlaneNode2 = renderer2->GetCurrentWorldGeometry2DNode();
  ...
  m_PlaneNode3 = renderer3->GetCurrentWorldGeometry2DNode();
