...
#ifndef MITKRIGIDREGISTRATIONTESTPRESET_H_HEADER
#define MITKRIGIDREGISTRATIONTESTPRESET_H_HEADER
...
namespace mitk {
   ...
   * \author Daniel Stein
   */
  class MITK_RIGIDREGISTRATION_EXPORT RigidRegistrationTestPreset : public vtkXMLParser
  {
  public:
    ...
    /**
    * \brief Tries to find mitkRigidRegistrationTestPresets.xml in /mitk/Config and loads all presets stored in this file.
    */
    bool LoadPreset();
    /**
