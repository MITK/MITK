...
namespace mitk {
MITK_TOOL_MACRO(MITKSEGMENTATION_EXPORT, ClassicRegionGrowingTool, "Classic region growing tool");
}

mitk::ClassicRegionGrowingTool::ClassicRegionGrowingTool()
...
void mitk::ClassicRegionGrowingTool::ConnectActionsAndFunctions()
{
...
const char** mitk::ClassicRegionGrowingTool::GetXPM() const
{
  return mitkRegionGrowingTool_xpm;
}

us::ModuleResource mitk::ClassicRegionGrowingTool::GetIconResource() const
{
...
us::ModuleResource mitk::ClassicRegionGrowingTool::GetCursorIconResource() const
{
  us::Module* module = us::GetModuleContext()->GetModule();
...
const char* mitk::ClassicRegionGrowingTool::GetName() const
{
  return "Classic Region Growing";
}

void mitk::ClassicRegionGrowingTool::Activated()
{
  Superclass::Activated();
}

void mitk::ClassicRegionGrowingTool::Deactivated()
{
...
*/
void mitk::ClassicRegionGrowingTool::OnMousePressed(StateMachineAction*, InteractionEvent* interactionEvent)
{
...
3.1.2 Set the result of this algorithm as the feedback contour
*/
bool mitk::ClassicRegionGrowingTool::OnMousePressedInside(StateMachineAction*, InteractionEvent* interactionEvent, mitkIpPicDescriptor* workingPicSlice, int initialWorkingOffset)
{
  mitk::InteractionPositionEvent* positionEvent = dynamic_cast<mitk::InteractionPositionEvent*>(interactionEvent);
...
3.2.3 Perform a region growing (which generates a new feedback contour)
*/
void mitk::ClassicRegionGrowingTool::OnMousePressedOutside(StateMachineAction*, InteractionEvent* interactionEvent)
{
  mitk::InteractionPositionEvent* positionEvent = dynamic_cast<mitk::InteractionPositionEvent*>(interactionEvent);
  //const PositionEvent* positionEvent = dynamic_cast<const PositionEvent*>(stateEvent->GetEvent()); // checked in OnMousePressed
...
*/
void mitk::ClassicRegionGrowingTool::OnMouseMoved(StateMachineAction*, InteractionEvent* interactionEvent)
{
...
*/
void mitk::ClassicRegionGrowingTool::OnMouseReleased(StateMachineAction*, InteractionEvent* interactionEvent)
{
...
*/
mitkIpPicDescriptor* mitk::ClassicRegionGrowingTool::PerformRegionGrowingAndUpdateContour(int timestep)
{
...
*/
void mitk::ClassicRegionGrowingTool::SmoothIPPicBinaryImageHelperForRows(mitkIpPicDescriptor* sourceImage, mitkIpPicDescriptor* dest, int &contourOfs, int* maskOffsets, int maskSize, int startOffset, int endOffset)
{
...
*/
mitkIpPicDescriptor* mitk::ClassicRegionGrowingTool::SmoothIPPicBinaryImage(mitkIpPicDescriptor* image, int &contourOfs, mitkIpPicDescriptor* dest)
{
