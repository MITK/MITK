...
bool mitk::LiveWireTool2D::OnInitLiveWire (Action* action, const StateEvent* stateEvent)
{
  ...
  m_ContourModelNode->SetProperty("color", ColorProperty::New(1, 1, 0));
  ...
  m_LiveWireContourNode->SetProperty( "color", ColorProperty::New(0.1, 1.0, 0.1));
  ...
  m_EditingContourNode->SetProperty( "color", ColorProperty::New(0.1, 1.0, 0.1));
