...
void mitk::SegmentationInteractor::Notify(InteractionEvent* interactionEvent, bool isHandled)
{
...
bool mitk::SegmentationInteractor::CheckPositionEvent( const InteractionEvent* interactionEvent )
{
...
bool mitk::SegmentationInteractor::Init(StateMachineAction*, InteractionEvent* interactionEvent)
{
...
bool mitk::SegmentationInteractor::Move(StateMachineAction*, InteractionEvent* interactionEvent)
{
  BaseRenderer* sender = interactionEvent->GetSender();
  InteractionPositionEvent* positionEvent = static_cast<InteractionPositionEvent*>(interactionEvent);
...
bool mitk::SegmentationInteractor::Zoom(StateMachineAction*, InteractionEvent* interactionEvent)
{
...
bool mitk::SegmentationInteractor::Scroll(StateMachineAction*, InteractionEvent* interactionEvent)
{
  InteractionPositionEvent* positionEvent = static_cast<InteractionPositionEvent*>(interactionEvent);
...
bool mitk::SegmentationInteractor::ScrollOneDown(StateMachineAction*, InteractionEvent* interactionEvent)
{
  mitk::SliceNavigationController::Pointer sliceNaviController = interactionEvent->GetSender()->GetSliceNavigationController();
...
bool mitk::SegmentationInteractor::ScrollOneUp(StateMachineAction*, InteractionEvent* interactionEvent)
{
  mitk::SliceNavigationController::Pointer sliceNaviController = interactionEvent->GetSender()->GetSliceNavigationController();
  if (!sliceNaviController->GetSliceLocked())
  {
...
bool mitk::SegmentationInteractor::AdjustLevelWindow(StateMachineAction*, InteractionEvent* interactionEvent)
{
...
void mitk::SegmentationInteractor::ConfigurationChanged()
{
...
bool mitk::SegmentationInteractor::FilterEvents(InteractionEvent* /*interactionEvent*/, DataNode* /*dataNode*/)
{
  return true;
}
