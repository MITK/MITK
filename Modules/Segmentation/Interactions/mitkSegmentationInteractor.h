...
namespace mitk
{
   ...
   */
  class Segmentation_EXPORT SegmentationInteractor: public EventStateMachine, public InteractionEventObserver
  {
  public:
    mitkClassMacro(SegmentationInteractor, EventStateMachine)
    itkNewMacro(Self)
    /**
  ...
  protected:
    ...
    /**
     * \brief Changes the active label.
     */
    virtual bool ChangeActiveLabel(StateMachineAction*, InteractionEvent*);
