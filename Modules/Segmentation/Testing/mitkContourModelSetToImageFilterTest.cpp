...
public:
  ...
  {
    mitk::Image::Pointer refImage = mitk::IOUtil::LoadImage(GetTestDataFilePath("ContourModel/RefImage.nrrd"));
    ...
    readerOutput = mitk::IOUtil::Load(GetTestDataFilePath("ContourModel/Contours.cnt_set"));
