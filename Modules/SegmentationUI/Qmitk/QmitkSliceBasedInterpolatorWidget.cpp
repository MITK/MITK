...
mitk::Image::Pointer QmitkSliceBasedInterpolatorWidget::GetWorkingSlice(const mitk::PlaneGeometry* planeGeometry)
{
  ...
  m_undoOperation = new mitk::DiffSliceOperation(m_WorkingImage, extractor->GetVtkOutput(), sliceGeometry, timeStep, const_cast<mitk::PlaneGeometry*>(planeGeometry));
...
void QmitkSliceBasedInterpolatorWidget::OnAcceptInterpolationClicked()
{
  if (m_WorkingImage.IsNotNull() && m_PreviewNode->GetData())
  {
    ...
    m_doOperation = new mitk::DiffSliceOperation(
      m_WorkingImage, extractor->GetVtkOutput(), sliceGeometry, timeStep, const_cast<mitk::PlaneGeometry*>(planeGeometry));
