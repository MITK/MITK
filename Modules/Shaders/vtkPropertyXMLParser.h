...
=========================================================================*/
// .NAME vtkPropertyXMLParser - represent surface properties of a geometric object
// .SECTION Description
// vtkPropertyXMLParser is an object that represents lighting and other surface
...
// .SECTION See Also
// vtkActor vtkPropertyXMLParserDevice

#ifndef __vtkPropertyXMLParser_h
#define __vtkPropertyXMLParser_h
...
class VTKRENDERINGCORE_EXPORT vtkPropertyXMLParser : public vtkObject
{
public:
  vtkTypeMacro(vtkPropertyXMLParser,vtkObject);
  ...
  static vtkPropertyXMLParser *New();

  // Description:
  // Assign one property to another.
  void DeepCopy(vtkPropertyXMLParser *p);
  ...
  // vtkPropertyXMLParser, which is created automatically. This
...
protected:
  ...
  void SetShaderProgram(vtkShaderProgram2*);
...
private:
  vtkPropertyXMLParser(const vtkPropertyXMLParser&);  // Not implemented.
  void operator=(const vtkPropertyXMLParser&);  // Not implemented.
...
inline const char *vtkPropertyXMLParser::GetInterpolationAsString(void)
{
...
// Description:
// Return the method of shading as a descriptive character string.
inline const char *vtkPropertyXMLParser::GetRepresentationAsString(void)
{
