...
namespace mitk
{
  ...
  * @ingroup ToFHardware
  */
  class MITK_TOFHARDWARE_EXPORT ToFNrrdImageWriter : public itk::Object
  {
  public: 
    mitkClassMacro( ToFNrrdImageWriter , itk::Object );
    itkNewMacro( Self );
  ...
  private:
    ...
    */
    ...
    //void ConvertStreamToNrrdFormat(std::ofstream* outfile);
    void ConvertStreamToNrrdFormat(std::ofstream* outfile, std::string fileName);
  };
} //END mitk namespace
