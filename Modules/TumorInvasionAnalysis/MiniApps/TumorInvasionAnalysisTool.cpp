...
int main(int argc, char *argv[]) {
    ...
    parser.addArgument("forestSize", "f", mitkCommandLineParser::Int,
                       "number of trees");
    parser.addArgument("samplingMode", "m", mitkCommandLineParser::Int,
...

    {
        mitk::DataCollectionImageIterator<unsigned char, 3> gtvIt(testCollection,
                                                                  "GTV");
        mitk::DataCollectionImageIterator<unsigned char, 3> result(testCollection,
                                                                   "RESULTOPEN");
    ...
    // insert GTV as tumor region, since it is known before, in the result.
    {
        mitk::DataCollectionImageIterator<unsigned char, 3> gtvIt(testCollection,
                                                                  "GTV");
        mitk::DataCollectionImageIterator<unsigned char, 3> brainMaskIter(
                    testCollection, "BRAINMASK");
        mitk::DataCollectionImageIterator<unsigned char, 3> result(testCollection,
                                                                   "RESULTOPEN");
