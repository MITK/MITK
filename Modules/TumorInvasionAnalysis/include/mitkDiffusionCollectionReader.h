...
#ifndef MITK_DIFFUSIONCOLLECTION_READER_H
#define MITK_DIFFUSIONCOLLECTION_READER_H
...
namespace mitk {
  class MITKTUMORINVASIONANALYSIS_EXPORT DiffusionCollectionReader : public vtkXMLParser
  {
  public:
    ...
    */
    ...
    ~DiffusionCollectionReader() override;
  protected:
