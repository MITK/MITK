...
const std::string CommandLineModulesViewConstants::VIEW_ID = "org.mitk.gui.qt.cmdlinemodules";
...
const std::string CommandLineModulesViewConstants::LOAD_FROM_APPLICATION_DIR = "load from application dir";
...
const std::string CommandLineModulesViewConstants::LOAD_FROM_APPLICATION_DIR_CLI_MODULES = "load from application dir/cli-modules";
