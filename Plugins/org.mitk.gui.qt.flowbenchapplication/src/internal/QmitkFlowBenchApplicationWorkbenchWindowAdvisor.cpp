...
// UGLYYY
#include "QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack.h"
...
QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack* QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack::undohack =
  new QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack();

QString QmitkFlowBenchApplicationWorkbenchWindowAdvisor::QT_SETTINGS_FILENAME = "QtSettings.ini";

class PartListenerForTitle: public berry::IPartListener
{
public:

  PartListenerForTitle(QmitkFlowBenchApplicationWorkbenchWindowAdvisor* wa)
    : windowAdvisor(wa)
  {
  }
...
private:
  QmitkFlowBenchApplicationWorkbenchWindowAdvisor* windowAdvisor;
};
...
public:
  ...
  PerspectiveListenerForTitle(QmitkFlowBenchApplicationWorkbenchWindowAdvisor* wa)
    : windowAdvisor(wa)
...
public:
  ...
  PerspectiveListenerForMenu(QmitkFlowBenchApplicationWorkbenchWindowAdvisor* wa)
    : windowAdvisor(wa)
  {
  }
...
QmitkFlowBenchApplicationWorkbenchWindowAdvisor::QmitkFlowBenchApplicationWorkbenchWindowAdvisor(berry::WorkbenchAdvisor* wbAdvisor,
...
QmitkFlowBenchApplicationWorkbenchWindowAdvisor::~QmitkFlowBenchApplicationWorkbenchWindowAdvisor()
{
}

QWidget* QmitkFlowBenchApplicationWorkbenchWindowAdvisor::CreateEmptyWindowContents(QWidget* parent)
{
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::ShowMemoryIndicator(bool show)
{
  showMemoryIndicator = show;
}

bool QmitkFlowBenchApplicationWorkbenchWindowAdvisor::GetShowMemoryIndicator()
{
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::ShowMitkVersionInfo(bool show)
{
  showMitkVersionInfo = show;
}

void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::SetProductName(const QString& product)
{
  productName = product;
}

void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::SetWindowIcon(const QString& wndIcon)
{
  windowIcon = wndIcon;
}

void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::PostWindowCreate()
{
  // very bad hack...
  ...
  undoAction = editMenu->addAction(berry::QtStyleManager::ThemeIcon(basePath + "edit-undo.svg"),
    "&Undo",
    QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack::undohack, SLOT(onUndo()),
    QKeySequence("CTRL+Z"));
  ...
  redoAction = editMenu->addAction(berry::QtStyleManager::ThemeIcon(basePath + "edit-redo.svg"),
    "&Redo",
    QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack::undohack, SLOT(onRedo()),
    QKeySequence("CTRL+Y"));
  ...
  resetPerspAction = windowMenu->addAction("&Reset Perspective",
    QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack::undohack, SLOT(onResetPerspective()));

  windowMenu->addSeparator();
  windowMenu->addAction("&Preferences...",
    QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack::undohack, SLOT(onEditPreferences()),
    QKeySequence("CTRL+P"));
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::PreWindowOpen()
{
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::PostWindowOpen()
{
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::onIntro()
{
  QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack::undohack->onIntro();
}

void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::onHelp()
{
  QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack::undohack->onHelp();
}

void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::onHelpOpenHelpPerspective()
{
  QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack::undohack->onHelpOpenHelpPerspective();
}

void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::onAbout()
{
...
QString QmitkFlowBenchApplicationWorkbenchWindowAdvisor::ComputeTitle()
{
  berry::IWorkbenchWindowConfigurer::Pointer configurer = GetWindowConfigurer();
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::RecomputeTitle()
{
  berry::IWorkbenchWindowConfigurer::Pointer configurer = GetWindowConfigurer();
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::UpdateTitle(bool editorHidden)
{
  berry::IWorkbenchWindowConfigurer::Pointer configurer = GetWindowConfigurer();
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::PropertyChange(const berry::Object::Pointer& /*source*/, int propId)
{
...
void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::SetPerspectiveExcludeList(const QList<QString>& v)
{
  this->perspectiveExcludeList = v;
}

QList<QString> QmitkFlowBenchApplicationWorkbenchWindowAdvisor::GetPerspectiveExcludeList()
{
  return this->perspectiveExcludeList;
}

void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::SetViewExcludeList(const QList<QString>& v)
{
  this->viewExcludeList = v;
}

QList<QString> QmitkFlowBenchApplicationWorkbenchWindowAdvisor::GetViewExcludeList()
{
  return this->viewExcludeList;
}

void QmitkFlowBenchApplicationWorkbenchWindowAdvisor::PostWindowClose()
{
  berry::IWorkbenchWindow::Pointer window = this->GetWindowConfigurer()->GetWindow();
...
QString QmitkFlowBenchApplicationWorkbenchWindowAdvisor::GetQSettingsFile() const
{
