...
#ifndef QMITKFLOWBENCHAPPLICATIONWORKBENCHWINDOWADVISOR_H_
#define QMITKFLOWBENCHAPPLICATIONWORKBENCHWINDOWADVISOR_H_
...
class MITK_QT_FLOW_BENCH_APP_EXPORT QmitkFlowBenchApplicationWorkbenchWindowAdvisor : public QObject, public berry::WorkbenchWindowAdvisor
{
  Q_OBJECT

public:

    QmitkFlowBenchApplicationWorkbenchWindowAdvisor(berry::WorkbenchAdvisor* wbAdvisor,
        berry::IWorkbenchWindowConfigurer::Pointer configurer);

    ~QmitkFlowBenchApplicationWorkbenchWindowAdvisor() override;
...
private:
  ...
  friend struct berry::PropertyChangeIntAdapter<QmitkFlowBenchApplicationWorkbenchWindowAdvisor>;
