...
class QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack : public QObject
{
  Q_OBJECT
  ...
  public:
    ...
    ~QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack() override;

    static QmitkFlowBenchApplicationWorkbenchWindowAdvisorHack* undohack;
};
