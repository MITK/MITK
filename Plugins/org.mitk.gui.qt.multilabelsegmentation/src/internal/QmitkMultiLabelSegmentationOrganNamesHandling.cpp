...
QStringList QmitkMultiLabelSegmentationView::GetDefaultOrganColorString()
{
...
void QmitkMultiLabelSegmentationView::UpdateOrganList(QStringList& organColors, const QString& organname, mitk::Color color)
{
...
void QmitkMultiLabelSegmentationView::AppendToOrganList(QStringList& organColors, const QString& organname, int r, int g, int b)
{
