...
//  m_Controls.m_ManualToolSelectionBox3D->SetDisplayedToolGroups("FastMarching3D RegionGrowing Watershed");
  m_Controls.m_ManualToolSelectionBox3D->SetDisplayedToolGroups("Threshold 'Two Thresholds' Median Dilate Erode Open Close 'Fill Holes' 'Keep N Largest' 'Split' 'Region Selector' 'Auto Threshold' 'Multiple Otsu'");
