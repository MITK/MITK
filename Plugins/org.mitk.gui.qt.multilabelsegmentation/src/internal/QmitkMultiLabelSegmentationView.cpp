...
void QmitkMultiLabelSegmentationView::CreateQtPartControl(QWidget* parent)
{
  ...
  m_Controls.m_ManualToolSelectionBox3D->SetDisplayedToolGroups("'Region Selector' Threshold 'Two Thresholds' 'Auto Threshold' 'Multiple Otsu'"); // todo add : FastMarching3D RegionGrowing Watershed
