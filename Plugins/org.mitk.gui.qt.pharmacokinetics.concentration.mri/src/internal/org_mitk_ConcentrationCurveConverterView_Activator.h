...
#ifndef org_mitk_ConcentrationCurveConverterView_Activator_h
#define org_mitk_ConcentrationCurveConverterView_Activator_h

#include <ctkPluginActivator.h>


    class org_mitk_ConcentrationCurveConverterView_Activator : public QObject, public ctkPluginActivator
	{
    Q_OBJECT
      Q_PLUGIN_METADATA(IID "org_mitk_gui_qt_pharmacokinetics_concentration_mri")
