...
class org_mitk_gui_qt_photoacousticsimulation_Activator :
...
}; // org_mitk_gui_qt_photoacousticsimulation_Activator

}

#endif // org_mitk_gui_qt_photoacousticsimulation_Activator_h
