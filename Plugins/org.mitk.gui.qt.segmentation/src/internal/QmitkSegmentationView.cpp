...
int QmitkSegmentationView::GetSizeFlags(bool width)
{
  if(!width)
  {
...
int QmitkSegmentationView::ComputePreferredSize(bool width, int /*availableParallel*/, int /*availablePerpendicular*/, int preferredResult)
{
  if(width==false)
  {
    return 200;
