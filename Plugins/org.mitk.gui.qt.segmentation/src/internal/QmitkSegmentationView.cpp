...
void QmitkSegmentationView::CreateQtPartControl(QWidget* parent)
{
  ...
  m_Controls->m_ManualToolSelectionBox2D->SetDisplayedToolGroups("Add Subtract Paint Wipe 'Region Growing' Correction Fill Erase LiveWire FastMarching");
  ...
  m_Controls->m_ManualToolSelectionBox3D->SetDisplayedToolGroups("Threshold 'Two Thresholds' FastMarching3D");
