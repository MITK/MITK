...
namespace RemoveFromSemanticRelationsAction
{
  void Run(mitk::SemanticRelations* semanticRelations, const mitk::DataStorage* dataStorage, const mitk::DataNode* dataNode)
  {
    ...
    {
      RemoveSegmentation(semanticRelations, dataStorage, dataNode);
    }
  }
  ...
  void RemoveSegmentation(mitk::SemanticRelations* semanticRelations, const mitk::DataStorage* dataStorage, const mitk::DataNode* segmentation)
  {
...
void QmitkDataNodeRemoveFromSemanticRelationsAction::OnActionTriggered(bool checked)
{
  ...
  RemoveFromSemanticRelationsAction::Run(m_SemanticRelations.get(), m_DataStorage.Lock(), dataNode);
}
