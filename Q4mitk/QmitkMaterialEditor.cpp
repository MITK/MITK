 ...
 * Contructor.
 */
QmitkMaterialEditor::QmitkMaterialEditor(QWidget* parent, const char* name, Qt::WindowFlags f)
  : QDialog(parent, f)
{
  this->setupUi(this);
 ...
 * Destructor
 */
QmitkMaterialEditor::~QmitkMaterialEditor()
{
...
void QmitkMaterialEditor::Initialize()
{
    ...
    Q3Grid * grid = new Q3Grid( static_cast<int>( sqrt( (double)m_MaterialProperties->size() ) ), Qt::Horizontal, m_GridContainer );
