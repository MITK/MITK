...
// function to round
double mitk::PicDescriptorToNodeSecond::Round(double number, unsigned int decimalPlaces)
{
...
// constructor
mitk::PicDescriptorToNodeSecond::PicDescriptorToNodeSecond()
{
}
...
// set-function
void mitk::PicDescriptorToNodeSecond::SetInput( std::list< ipPicDescriptor* > inputPicDescriptorList, std::string inputSeriesOID )
{
...
// get-function
std::vector< mitk::DataTreeNode::Pointer > mitk::PicDescriptorToNodeSecond::GetOutput()
{
  return m_Output;
}

// the "main"-function
void mitk::PicDescriptorToNodeSecond::Update()
{
  m_Output.clear();
  groupList.clear();
...
void mitk::PicDescriptorToNodeSecond::SortSlicesToGroup()
{
...
void mitk::PicDescriptorToNodeSecond::SortGroupsByLocation()
{
...
bool mitk::PicDescriptorToNodeSecond::LocationSort( const Slice elem1, const Slice elem2 )
{
...
void mitk::PicDescriptorToNodeSecond::CreatePossibleCombinations()
{
#ifdef CHILI_PLUGIN_VERSION_CODE
...
void mitk::PicDescriptorToNodeSecond::SortPossibleCombinations()
{
...
bool mitk::PicDescriptorToNodeSecond::CombinationSort( const std::set< Slice* > elem1, const std::set< Slice* > elem2 )
{
  return elem1.size() > elem2.size();
}

void mitk::PicDescriptorToNodeSecond::SearchForMinimumCombination()
{
#ifdef CHILI_PLUGIN_VERSION_CODE
  for( unsigned int n = 0; n < groupList.size(); n++ )
  {
...
void mitk::PicDescriptorToNodeSecond::RekCombinationSearch( std::vector< std::set< Slice* > >::iterator iterBegin, std::set< Slice* > currentCombination, std::vector< std::set< Slice* > > resultCombination )
{
#ifdef CHILI_PLUGIN_VERSION_CODE
...
void mitk::PicDescriptorToNodeSecond::GenerateNodes()
{
#ifdef CHILI_PLUGIN_VERSION_CODE
  for( unsigned int n = 0; n < groupList.size(); n++)
  {
...
const mitk::PropertyList::Pointer mitk::PicDescriptorToNodeSecond::CreatePropertyListFromPicTags( ipPicDescriptor* imageToExtractTagsFrom )
{
...
void mitk::PicDescriptorToNodeSecond::ShowAllGroupsWithSlices()
{
  for( unsigned int n = 0; n < groupList.size(); n++)
  {
...
void mitk::PicDescriptorToNodeSecond::ShowAllPossibleCombinations()
{
  for( unsigned int n = 0; n < groupList.size(); n++)
  {
...
void mitk::PicDescriptorToNodeSecond::ShowAllResultCombinations()
{
  for( unsigned int n = 0; n < groupList.size(); n++)
  {
...
void mitk::PicDescriptorToNodeSecond::ShowAllSlicesWithUsedSpacings()
{
  for( unsigned int n = 0; n < groupList.size(); n++)
  {
    for( std::vector< Slice >::iterator it = groupList[n].includedSlices.begin(); it != groupList[n].includedSlices.end(); it++ )
