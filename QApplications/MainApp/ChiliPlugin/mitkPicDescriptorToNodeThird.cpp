...
// function to round
double mitk::PicDescriptorToNodeThird::Round(double number, unsigned int decimalPlaces)
{
...
// constructor
mitk::PicDescriptorToNodeThird::PicDescriptorToNodeThird()
{
}
...
// set-function
void mitk::PicDescriptorToNodeThird::SetInput( std::list< ipPicDescriptor* > inputPicDescriptorList, std::string inputSeriesOID )
{
...
// get-function
std::vector< mitk::DataTreeNode::Pointer > mitk::PicDescriptorToNodeThird::GetOutput()
{
  return m_Output;
}

// the "main"-function
void mitk::PicDescriptorToNodeThird::Update()
{
  m_Output.clear();
  groupList.clear();
...
void mitk::PicDescriptorToNodeThird::SortSlicesToGroup()
{
...
void mitk::PicDescriptorToNodeThird::SortGroupsByLocation()
{
...
bool mitk::PicDescriptorToNodeThird::LocationSort( const PositionAtSpace elem1, const PositionAtSpace elem2 )
{
...
void mitk::PicDescriptorToNodeThird::CreateSpacings()
{
#ifdef CHILI_PLUGIN_VERSION_CODE
...
bool mitk::PicDescriptorToNodeThird::SpacingCountSort( const Spacing elem1, const Spacing elem2 )
{
  //helpfunction to sort the found spacings, the higher one get first
  return elem1.count > elem2.count;
}

bool mitk::PicDescriptorToNodeThird::ImageNumberSort( const Slice elem1, const Slice elem2 )
{
...
void mitk::PicDescriptorToNodeThird::GenerateNodes()
{
#ifdef CHILI_PLUGIN_VERSION_CODE
  for( unsigned int n = 0; n < groupList.size(); n++)
  {
...
const mitk::PropertyList::Pointer mitk::PicDescriptorToNodeThird::CreatePropertyListFromPicTags( ipPicDescriptor* imageToExtractTagsFrom )
{
...
void mitk::PicDescriptorToNodeThird::ShowAllGroupsWithSlices()
{
  for( unsigned int n = 0; n < groupList.size(); n++)
  {
    std::cout << "-----------" << std::endl;
...
void mitk::PicDescriptorToNodeThird::ShowAllFoundSpacings()
{
  for( unsigned int n = 0; n < groupList.size(); n++)
  {
    std::cout << "-----------" << std::endl;
