...
#ifndef PICDESCRIPTORTONODETHIRD_H_HEADER_INCLUDED
#define PICDESCRIPTORTONODETHIRD_H_HEADER_INCLUDED
...
class PicDescriptorToNodeThird : public itk::Object
{
  public:

    /** constuctor and destructor */
   mitkClassMacro( PicDescriptorToNodeThird, itk::Object );
   itkNewMacro( PicDescriptorToNodeThird);
