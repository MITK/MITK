...
std::cout << "CloseFirstMessageBox:   QApplication reports a list of top-level widgets: " << toplevelWidgets->count() << " widgets" << std::endl;
  QWidget* widget;
...
std::cout << "CloseFirstMessageBox: Searching " << widget->name() << " for QPushButton children. Found " << childList->count() << " buttons. Task is to click " << m_WhichButton << ". button." << std::endl;
...
std::cout << "CloseFirstMessageBox: Button '" << button->name() << "' (label '" << button->text().ascii() << "') gets our index " << count << std::endl;

        if ( count == m_WhichButton )
        {
std::cout << "CloseFirstMessageBox: This is a very good index (==m_WhichButton), will simulate a click on that button." << std::endl;
...
std::cout << "CloseFirstMessageBox: Terminating timer of QmitkMessageBoxHelper::CloseMessageBoxes(which,delay)" << std::endl;
          m_Timer.stop();
        }
