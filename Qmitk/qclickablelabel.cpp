...
QClickableLabel::QClickableLabel( QWidget* parent, const char* name, WFlags f )
...
QClickableLabel::QClickableLabel( const QString& text, QWidget* parent, const char* name, WFlags f )
