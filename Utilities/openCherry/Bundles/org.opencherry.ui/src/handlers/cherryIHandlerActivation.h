...
#ifndef CHERRYIHANDLERACTIVATION_H_
#define CHERRYIHANDLERACTIVATION_H_
 ...
 */
struct CHERRY_UI IHandlerActivation : public IEvaluationResultCache {

  cherryInterfaceMacro(IHandlerActivation, cherry)
...
#endif /* CHERRYIHANDLERACTIVATION_H_ */
