...
#ifndef CHERRYEXPRESSIONCONVERTER_H_
#define CHERRYEXPRESSIONCONVERTER_H_
...
public:
   ...
   */
  Expression::Pointer Perform(IConfigurationElement* root);
  ...
  void ProcessChildren(IConfigurationElement* element, CompositeExpression* result);

  std::string GetDebugPath(IConfigurationElement* configurationElement);

  void ProcessChildren(Poco::XML::Element* element, CompositeExpression* result);
};

}  // namespace cherry

#endif /*CHERRYEXPRESSIONCONVERTER_H_*/
