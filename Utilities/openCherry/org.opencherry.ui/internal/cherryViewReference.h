...
protected: virtual PartPane CreatePane() {
...
public: virtual std::string GetSecondaryId() {
   ...
   */
public: virtual IViewPart::Ptr GetView(bool restore) {
   ...
   */
protected: virtual IWorkbenchPart::Ptr CreatePart() {
...
private: IWorkbenchPart::Ptr CreatePartHelper() throws PartInitException {
