...
protected: SmartPointer<ILayoutContainer> container;
  ...
  private: int deferCount;
     ...
     */
    public: virtual std::string GetCompoundId();

    public: virtual bool IsCompressible();
    
    public: virtual bool IsDocked() = 0;
   ...
   */
     ...
     * Reparent a part.
     */
    public: virtual void Reparent(void* newParent) = 0;
     ...
     */
    public: virtual bool GetVisible() = 0;
     ...
     */
    public: virtual void SetVisible(bool makeVisible) = 0;

    /**
     * Returns <code>true</code> if the given control or any of its descendents has focus.
     */
    private: virtual bool IsFocusAncestor(void* ctrl) = 0;
     ...
     * @param buf
     */
    public: virtual void DescribeLayout(std::string& buf);
