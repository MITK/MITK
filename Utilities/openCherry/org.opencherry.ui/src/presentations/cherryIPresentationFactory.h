...
#ifndef CHERRYIPRESENTATIONFACTORY_H_
#define CHERRYIPRESENTATIONFACTORY_H_
 ...
 * @since 3.0
 */
class CHERRY_UI IPresentationFactory {

public:

  cherryManifestMacro(IPresentationFactory, cherry);
...
#endif /* CHERRYABSTRACTPRESENTATIONFACTORY_H_ */
