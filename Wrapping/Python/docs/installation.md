...
- A Python version matching one of the published wheel tags: CPython 3.12,
  3.13, or 3.14. The wheel is a binary build pinned to a specific CPython
  ABI; `pip` will refuse to install the wrong tag.
