...
#ifndef CHERRYCOMMANDEVENT_H_
#define CHERRYCOMMANDEVENT_H_
 ...
 */
class CHERRY_COMMANDS CommandEvent : public AbstractNamedHandleEvent {

public:

  cherryObjectMacro(CommandEvent)
