...
namespace cherry 
{
  ...
  public:
    ...
    ///
    cherryObjectMacro(cherry::Preferences)
    ///
...
///
std::ostream& operator<<(std::ostream& os,const cherry::Preferences& m);
