...
public:
   ...
   * (non-Javadoc)
   *
   * @see org.opencherry.ui.IWorkbenchPage
   */
public:
...
public:
   ...
   * (non-Javadoc)
   *
   * @see org.opencherry.ui.IWorkbenchPage#showView(java.lang.String,
...
private:
   ...
   * (non-Javadoc)
   *
   * @see org.opencherry.ui.IWorkbenchPage#getViewStack(org.opencherry.ui.IViewPart)
   */
public:
...
public:
   ...
   * (non-Javadoc)
   *
   * @see org.opencherry.ui.IWorkbenchPage#getShowViewShortcuts()
   */
public:
