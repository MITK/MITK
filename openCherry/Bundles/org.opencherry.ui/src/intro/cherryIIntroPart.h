...
#ifndef CHERRYIINTROPART_H_
#define CHERRYIINTROPART_H_
 ...
 * <code>org.opencherry.ui.intro</code> extension point.  There can be several
 ...
 * {@link cherry::Platform#GetProduct()}. There is at most one
 ...
 * {@link cherry::IntroPart}.
 * </p>
 *
 * @see IIntroManager#ShowIntro(IWorkbenchWindow::Pointer, bool)
 * @noimplement This interface is not intended to be implemented by clients.
 */
struct CHERRY_UI IIntroPart : public virtual Object { // IAdaptable {

  cherryInterfaceMacro(IIntroPart, cherry)
