...
#ifndef CHERRYTESTABLEOBJECT_H_
#define CHERRYTESTABLEOBJECT_H_
 ...
 * @since 3.0
 */
class CHERRY_UI TestableObject : public virtual Object {
...
public:
  ...
  cherryObjectMacro(TestableObject)
